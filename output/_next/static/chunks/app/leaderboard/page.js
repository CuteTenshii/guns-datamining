  ...
  [1410], {
    25997: (a, e, l) => {
      ...
      function m({
        ...
        let e = a?.tokenData,
          l = a?.statsData,
          [i, n] = (0, t.useState)("all"),
          [m, _] = (0, t.useState)(null),
          [w, p] = (0, t.useState)(!0),
          [g, b] = (0, t.useState)(null),
          x = (0, c.kj)();
        (0, t.useEffect)(() => {
          let a = !0;
          return (async () => {
            try {
              ...
              let e = await fetch("/api/leaderboard/views", {
                ...
                l = await e.json();
              if (!a) return;
              !e.ok || l?.error ? b(l?.error) : (_(l), b(null))
            } catch (e) {
              if (!a) return;
              b(e?.message)
            } finally {
        ...
        let v = m?.allTime || [],
          u = m?.month || [],
          j = (0, t.useMemo)(() => "all" === i ? v : u, [i, v, u]),
          k = x("all" === i ? "leaderboard.hero.description_alltime" : "leaderboard.hero.description_thismonth");
        return (0, r.jsx)(s.A, {
          data: e,
          statsData: l,
          children: (0, r.jsx)("div", {
            className: d().leaderboardPage,
            children: (0, r.jsxs)("div", {
              ...
              children: [(0, r.jsxs)("div", {
                ...
                children: [(0, r.jsx)("h1", {
                  className: d().title,
                  children: x("leaderboard.hero.title")
                }), (0, r.jsx)("p", {
                  ...
                  children: [(0, r.jsx)("button", {
                    className: `${d().tabButton} ${"all"===i?d().tabActive:""}`,
                    onClick: () => n("all"),
                    type: "button",
                    children: x("leaderboard.hero.tab_alltime")
                  }), (0, r.jsx)("button", {
                    className: `${d().tabButton} ${"month"===i?d().tabActive:""}`,
                    onClick: () => n("month"),
                    type: "button",
                    children: x("leaderboard.hero.tab_thismonth")
                  })]
                })]
              }), (0, r.jsxs)("div", {
                className: d().listWrapper,
                children: [(0, r.jsxs)("div", {
                  className: d().listHeader,
                  children: [(0, r.jsx)("span", {
                    children: "#"
                  }), (0, r.jsx)("span", {
                    children: x("leaderboard.table.profile_row_title")
                  }), (0, r.jsx)("span", {
                    style: {
                      textAlign: "right"
                    },
                    children: x("leaderboard.table.views_row_title")
                  })]
                }), w ? (0, r.jsx)("div", {
                  className: d().emptyState,
                  children: x("leaderboard.table.leaderboard_loading_text")
                }) : g ? (0, r.jsx)("div", {
                  className: d().emptyState,
                  children: g
                }) : 0 === j.length ? (0, r.jsx)("div", {
                  className: d().emptyState,
                  children: x("leaderboard.table.no_data_text")
                }) : (0, r.jsx)(r.Fragment, {
                  children: j.map((a, e) => {
                    let l = e < 3 ? d().rankTop : "",
                      t = 0 === e ? d().rowTop1 : 1 === e ? d().rowTop2 : 2 === e ? d().rowTop3 : "",
                      s = a.displayName || a.username || "Unknown",
                      i = a.username || "unknown",
                    ...
                    return (0, r.jsx)(h(), {
                      ...
                      children: (0, r.jsxs)("div", {
                        ...
                        children: [(0, r.jsx)("span", {
                          ...
                          className: d().profile,
                          children: [a.avatar ? (0, r.jsx)("img", {
                            className: d().avatar,
                            src: a.avatar,
                            alt: ""
                          }) : (0, r.jsx)("div", {
                            className: d().avatarFallback,
                            children: c
                          }), (0, r.jsxs)("div", {
                            className: d().nameBlock,
                            children: [(0, r.jsxs)("div", {
                              className: d().displayLine,
                              children: [(0, r.jsx)("h1", {
                                className: d().displayName,
                                children: s
                              }), m && (0, r.jsx)("span", {
                                className: d().premiumBadge,
                                children: (0, r.jsx)("span", {
                                  className: d().premiumIcon,
                                  children: o.A.premium
                                })
                              })]
                            }), (0, r.jsxs)("span", {
    ...
    86623: a => {
      a.exports = {
        leaderboardPage: "leaderboardPage_leaderboardPage__nYsIf",
        container: "leaderboardPage_container__KOugl",
        hero: "leaderboardPage_hero__mK9iV",
        title: "leaderboardPage_title__VxkLi",
        subtitle: "leaderboardPage_subtitle__olvAS",
        tabs: "leaderboardPage_tabs__ij0i6",
        tabButton: "leaderboardPage_tabButton__d8zZ4",
        tabActive: "leaderboardPage_tabActive__b1orq",
        listWrapper: "leaderboardPage_listWrapper__dYnyO",
        listHeader: "leaderboardPage_listHeader__MXji1",
        row: "leaderboardPage_row__GnXnv",
        rowTop1: "leaderboardPage_rowTop1__hK3CS",
        rowTop2: "leaderboardPage_rowTop2__9LkY5",
        rowTop3: "leaderboardPage_rowTop3__fHzEy",
        rank: "leaderboardPage_rank__B8S9g",
        rankTop: "leaderboardPage_rankTop__SQitH",
        profile: "leaderboardPage_profile__BNyFj",
        displayLine: "leaderboardPage_displayLine__KXe3T",
        avatar: "leaderboardPage_avatar__Ag42E",
        avatarFallback: "leaderboardPage_avatarFallback___SVfp",
        nameBlock: "leaderboardPage_nameBlock__IjmLJ",
        displayName: "leaderboardPage_displayName__PeJkA",
        rowLink: "leaderboardPage_rowLink__uY9vi",
        premiumBadge: "leaderboardPage_premiumBadge__J0TED",
        premiumIcon: "leaderboardPage_premiumIcon__C_lND",
        username: "leaderboardPage_username__SinCq",
        views: "leaderboardPage_views__B9Zwj",
        emptyState: "leaderboardPage_emptyState__3KdnE"
      }
    }
  },
  a => {
    a.O(0, [9404, 8121, 6992, 8500, 8256, 5886, 226, 1382, 8441, 3794, 7358], () => a(a.s = 41143)), _N_E = a.O()
  }
]);