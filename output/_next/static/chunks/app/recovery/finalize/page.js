(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9415], {
    10939: (e, a, t) => {
      Promise.resolve().then(t.bind(t, 17891))
    },
    17891: (e, a, t) => {
      "use strict";
      t.d(a, {
      ...
      function u() {
        ...
        let v = async () => {
          if (y && !u && !N) try {
            ...
            let a = await fetch("/api/recovery/finalize", {
              ...
              t = await a.json();
            if (!a.ok) {
              let a = t.error || e("auth.recovery.finalize.errors.unable_finalize");
        ...
        return y ? N ? (0, n.jsx)(c.A, {
          ...
          children: (0, n.jsxs)("div", {
            className: _().startContainer,
            children: [(0, n.jsxs)("div", {
              className: _().finalizeChangesPanel,
              children: [(0, n.jsx)("h3", {
                className: _().finalizeChangesTitle,
                children: e("auth.recovery.finalize.changes_title")
              }), g ? (0, n.jsx)("p", {
                className: _().finalizeChangesLoading,
                children: e("auth.recovery.finalize.loading_changes")
              }) : (0, n.jsx)("ul", {
                className: _().finalizeChangesList,
                children: ("lost_email_access" === p ? [{
                  id: "new-email",
                  content: e("auth.recovery.finalize.planned.new_email")
                }] : "lost_2fa_device" === p || "lost_recovery_codes" === p ? [{
                  id: "disable-2fa",
                  content: e("auth.recovery.finalize.planned.disable_2fa")
                }] : "lost_email_and_2fa" === p ? [{
                  id: "disable-2fa",
                  content: e("auth.recovery.finalize.planned.disable_2fa")
                }, {
                  id: "new-email",
                  ...
                  id: "new-email",
                  content: e("auth.recovery.finalize.planned.new_email")
                }] : "compromised_account" === p ? [{
                  id: "password-reset",
                  content: (0, n.jsxs)(n.Fragment, {
                    children: [e("auth.recovery.finalize.planned.password_reset_prefix"), " ", " ", (0, n.jsx)(s.A, {
                      href: "/reset",
                      className: _().inlineActionLink,
                      children: "/reset"
                    }), "."]
                  })
                }, {
                  ...
                  className: _().finalizeChangesItem,
                  children: [(0, n.jsx)("span", {
                    className: _().finalizeChangesDot,
                    children: "•"
                  }), (0, n.jsx)("span", {
                    children: e.content
                  })]
              ...
              children: [(0, n.jsx)("button", {
                ...
                onClick: v,
                disabled: u || g,
                children: u ? e("auth.recovery.finalize.finalizing") : e("auth.recovery.finalize.confirm")
              })]
            })]
          })
        }) : (0, n.jsxs)(c.A, {
    ...
    73321: (e, a, t) => {
      "use strict";
      var n = t(74645);
      t.o(n, "redirect") && t.d(a, {
        redirect: function() {
          return n.redirect
        }
      }), t.o(n, "useParams") && t.d(a, {
        useParams: function() {
          return n.useParams
        }
      }), t.o(n, "usePathname") && t.d(a, {
        usePathname: function() {
          return n.usePathname
        }
      }), t.o(n, "useRouter") && t.d(a, {
        useRouter: function() {
          return n.useRouter
        }
      }), t.o(n, "useSearchParams") && t.d(a, {
    ...
    81934: (e, a, t) => {
      ...
      function s({
        ...
        let d = t || (0, c.useLang)();
        if (e.startsWith("http://") || e.startsWith("https://") || e.startsWith("mailto:") || e.startsWith("tel:")) return a ? (0, n.jsx)("a", {
          href: e,
          ...s,
          children: i
        }) : (0, n.jsx)(r(), {
    ...
    94345: (e, a, t) => {
      ...
      class c {
        ...
        tr(e, a, t) {
          var n, c;
          let s = this.isSupportedLocale(t) ? t : this.language,
            d = this.getTemplate(e, s);
          return a && 0 !== Object.keys(a).length ? Object.values(a).some(e => null != e && "string" != typeof e && "number" != typeof e) ? function(e, a) {
            let t, n = [],
              c = /\{(\w+)\}/g,
              s = 0;
            for (; null !== (t = c.exec(e));) {
              t.index > s && n.push(e.slice(s, t.index));
              let i = a[t[1]];
              null == i ? n.push("") : n.push(i), s = c.lastIndex
            }
            return (s < e.length && n.push(e.slice(s)), 1 === n.length) ? n[0] : n.map((e, a) => r.isValidElement(e) ? r.cloneElement(e, {
              key: e.key ?? `part-${a}`
            }) : "string" == typeof e || "number" == typeof e ? e : (0, i.jsxs)(r.Fragment, {
              children: [" ", e, " "]
            }, `part-${a}`))
          }(d, a) : (n = d, c = a, n.replace(/\{(\w+)\}/g, (e, a) => String(c[a] ?? ""))) : d
        }
        localeHref(e, a) {
        ...
        getTemplate(e, a) {
          let [t, n] = s(e);
          if (!t || !n) return e;
          let i = this.dictionaries[a]?.[t],
            r = this.dictionaries.en?.[t],
            c = n.split("."),
            l = d(i, c);
          return void 0 !== l ? l : d(r, c) ?? e
        }
      }
      let s = e => e.split(/\.(.+)/);
      ...
      function o(e, a) {
        ...
        let n = t[0];
        return _(a).includes(n) ? "/" + t.slice(1).join("/") : e
      }

      function f(e, a) {
        if ("undefined" == typeof document) return;
        let t = _().includes(e) ? e : "en",
          n = new Date;
        n.setTime(n.getTime() + 31536e6);
        let i = n.toUTCString();
        if (document.cookie = `GUNS_LOCALE=${t}; expires=${i}; path=/`, document.cookie = `GUNS_PATH_LOCALE=${t}; expires=${i}; path=/`, a?.redirect) {
          window.location.href = a.redirect;
          return
        }
        window.location.href = o(window.location.pathname)
      }
    ...
    96351: (e, a, t) => {
      ...
      function s({
        ...
        let d = e || "en",
          l = (0, i.useRef)(null),
          o = (0, i.useRef)(null);
        l.current || (l.current = (0, r.qC)());
        let f = l.current;
        o.current && o.current.language === d && o.current.messages === a && o.current.availableLocales === t || (f.initLanguage(d, a, t), o.current = {
          language: d,
          messages: a,
          availableLocales: t
        }), (0, i.useEffect)(() => {
        ...
        let _ = (0, i.useMemo)(() => ({
          lang: f.getLanguage(),
          tr: (e, a, t) => f.tr(e, a, t),
          localeHref: (e, a) => f.localeHref(e, a),
          availableLocales: t
        }), [f, d, t]);
  ...
  e => {
    e.O(0, [1406, 8500, 8441, 3794, 7358], () => e(e.s = 10939)), _N_E = e.O()
  }
]);