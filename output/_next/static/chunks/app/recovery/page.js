(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4012], {
    1011: (e, a, t) => {
      Promise.resolve().then(t.bind(t, 6237))
    },
    6237: (e, a, t) => {
      "use strict";
      t.d(a, {
      ...
      function _() {
        ...
        return (0, c.jsx)(r.A, {
          ...
          children: (0, c.jsx)("div", {
            className: n().recoveryCards,
            children: o.map(a => {
              var t;
              return (0, c.jsxs)(d.A, {
                href: "forgot_password" === (t = a.id) ? "/reset" : `/recovery/start?type=${t}`,
                className: n().recoveryCard,
                children: [(0, c.jsx)("span", {
                  className: n().cardIcon,
                  children: a.icon
                }), (0, c.jsx)("h2", {
                  children: e(`auth.recovery.selector.types.${a.id}`)
                })]
              }, a.id)
            })
          })
    ...
    81934: (e, a, t) => {
      ...
      function i({
        ...
        let o = "en" == n ? `${e.startsWith("/")?"":"/"}${e}` : `/${n}${e.startsWith("/")?"":"/"}${e}`;
        return a ? (0, c.jsx)("a", {
          href: o,
          ...i,
          children: r
    ...
    94345: (e, a, t) => {
      ...
      class s {
        ...
        tr(e, a, t) {
          var c, s;
          let i = this.isSupportedLocale(t) ? t : this.language,
            n = this.getTemplate(e, i);
          return a && 0 !== Object.keys(a).length ? Object.values(a).some(e => null != e && "string" != typeof e && "number" != typeof e) ? function(e, a) {
            let t, c = [],
              s = /\{(\w+)\}/g,
              i = 0;
            for (; null !== (t = s.exec(e));) {
              t.index > i && c.push(e.slice(i, t.index));
              let r = a[t[1]];
              null == r ? c.push("") : c.push(r), i = s.lastIndex
            }
            return (i < e.length && c.push(e.slice(i)), 1 === c.length) ? c[0] : c.map((e, a) => d.isValidElement(e) ? d.cloneElement(e, {
              key: e.key ?? `part-${a}`
            }) : "string" == typeof e || "number" == typeof e ? e : (0, r.jsxs)(d.Fragment, {
              children: [" ", e, " "]
            }, `part-${a}`))
          }(n, a) : (c = n, s = a, c.replace(/\{(\w+)\}/g, (e, a) => String(s[a] ?? ""))) : n
        }
        localeHref(e, a) {
        ...
        getTemplate(e, a) {
          let [t, c] = i(e);
          if (!t || !c) return e;
          let r = this.dictionaries[a]?.[t],
            d = this.dictionaries.en?.[t],
            s = c.split("."),
            o = n(r, s);
          return void 0 !== o ? o : n(d, s) ?? e
        }
      }
      let i = e => e.split(/\.(.+)/);
      ...
      function n(e, a) {
        ...
        for (let e of a) {
          var c;
          if ("object" != typeof(c = t) || null === c) return;
          t = t[e]
        }
      ...
      function _(e, a) {
        ...
        let c = t[0];
        return l(a).includes(c) ? "/" + t.slice(1).join("/") : e
      }

      function f(e, a) {
        if ("undefined" == typeof document) return;
        let t = l().includes(e) ? e : "en",
          c = new Date;
        c.setTime(c.getTime() + 31536e6);
        let r = c.toUTCString();
        if (document.cookie = `GUNS_LOCALE=${t}; expires=${r}; path=/`, document.cookie = `GUNS_PATH_LOCALE=${t}; expires=${r}; path=/`, a?.redirect) {
          window.location.href = a.redirect;
          return
        }
        window.location.href = _(window.location.pathname)
      }
    ...
    96351: (e, a, t) => {
      ...
      function i({
        ...
        let n = e || "en",
          o = (0, r.useRef)(null),
          _ = (0, r.useRef)(null);
        o.current || (o.current = (0, d.qC)());
        let f = o.current;
        _.current && _.current.language === n && _.current.messages === a && _.current.availableLocales === t || (f.initLanguage(n, a, t), _.current = {
          language: n,
          messages: a,
          availableLocales: t
        }), (0, r.useEffect)(() => {
  ...
  e => {
    e.O(0, [1406, 8500, 8441, 3794, 7358], () => e(e.s = 1011)), _N_E = e.O()
  }
]);