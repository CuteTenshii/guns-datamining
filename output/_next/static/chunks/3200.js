  ...
  [3200], {
    ...
    94345: (e, t, a) => {
      ...
      class i {
        ...
        initLanguage(e, t = {}, a = []) {
          if (this.hydrateFromWindow(), a.length > 0 && (this.supportedLocales = a.includes("en") ? a : ["en", ...a]), Object.keys(t).length > 0)
            for (let [e, a] of Object.entries(t)) a && (this.dictionaries[e] = a);
          this.isSupportedLocale(e) ? this.language = e : this.language = "en", this.dictionaries.en || (this.dictionaries.en = t.en ?? this.dictionaries[this.language])
        }
        getLanguage() {
        ...
        localeHref(e, t) {
          ...
          return (this.isSupportedLocale(a) || (a = "en"), "en" === a) ? e : (e.startsWith("/") || (e = "/" + e), `/${a}${e}`)
        }
        hydrateFromWindow() {
          if (this.hydratedFromWindow) return;
          let e = window;
          if (e.z___GUNS_LOCALE_MESSAGES__)
            for (let [t, a] of Object.entries(e.z___GUNS_LOCALE_MESSAGES__)) !this.dictionaries[t] && a && (this.dictionaries[t] = a);
          e.z___GUNS_AVAILABLE_LOCALES__ && (this.supportedLocales = e.z___GUNS_AVAILABLE_LOCALES__), this.hydratedFromWindow = !0
        }
        isSupportedLocale(e) {
          return !!e && this.supportedLocales.includes(e)
        }
        getTemplate(e, t) {
          let [a, r] = n(e);
          if (!a || !r) return e;
          let l = this.dictionaries[t]?.[a],
            c = this.dictionaries.en?.[a],
            i = r.split("."),
            o = s(l, i);
      ...
      function s(e, t) {
        ...
        for (let e of t) {
          var r;
          if ("object" != typeof(r = a) || null === r) return;
          a = a[e]
        }
      ...
      function d(e, t) {
        ...
        let r = a[0];
        return g(t).includes(r) ? "/" + a.slice(1).join("/") : e
      }

      function h(e, t) {
        if ("undefined" == typeof document) return;
        let a = g().includes(e) ? e : "en",
          r = new Date;
        r.setTime(r.getTime() + 31536e6);
        let l = r.toUTCString();
        if (document.cookie = `GUNS_LOCALE=${a}; expires=${l}; path=/`, document.cookie = `GUNS_PATH_LOCALE=${a}; expires=${l}; path=/`, t?.redirect) {
          window.location.href = t.redirect;
          return
        }
        window.location.href = d(window.location.pathname)
      }
    ...
    96351: (e, t, a) => {
      ...
      function n({
        ...
        let s = e || "en",
          o = (0, l.useRef)(null),
          d = (0, l.useRef)(null);
        o.current || (o.current = (0, c.qC)());
        let h = o.current;
        d.current && d.current.language === s && d.current.messages === t && d.current.availableLocales === a || (h.initLanguage(s, t, a), d.current = {
          language: s,
          messages: t,
          availableLocales: a
        }), (0, l.useEffect)(() => {
          let e = window;
          e.z___GUNS_LOCALE_MESSAGES__ = t, e.z___GUNS_AVAILABLE_LOCALES__ = a
        }, [t, a]);
        let g = (0, l.useMemo)(() => ({
          lang: h.getLanguage(),
          tr: (e, t, a) => h.tr(e, t, a),
          localeHref: (e, t) => h.localeHref(e, t),
          availableLocales: a
        }), [h, s, a]);
      ...
      function s() {
        ...
        if (!e) throw Error("useT must be used inside <LanguageProvider>");
        return e.tr
      }

      function o() {
        let e = (0, l.useContext)(i);
        if (!e) throw Error("useAvailableLocales must be used inside <LanguageProvider>");
        return e.availableLocales
      }

      function d() {
        let e = (0, l.useContext)(i);
        if (!e) throw Error("useLocaleHref must be used inside <LanguageProvider>");
        return e.localeHref
      }

      function h() {
        let e = (0, l.useContext)(i);
        if (!e) throw Error("useLang must be used inside <LanguageProvider>");
        return e.lang
      }
    },
    98241: e => {
