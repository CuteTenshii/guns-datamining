...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [6079], {
    5354: (e, t, r) => {
      ...
      var n, a, o, s, i, u, p, l, c = r(49304).hp;
      ...
      function f(e, t) {
        this.source = e, this.sourceIndex = 0, this.tag = 0, this.bitcount = 0, this.dest = t, this.destLen = 0, this.ltree = new h, this.dtree = new h
      }
      ...
      function O(e, t, r, n) {
        ...
        for (o = 0, e.table[0] = 0, a = 0; a < 16; ++a) U[a] = o, o += e.table[a];
        for (a = 0; a < n; ++a) t[r + a] && (e.trans[U[t[r + a]]++] = a)
      }
      ...
      function R(e, t) {
        ...
        var r = 0,
          ...
          a = 0,
          o = e.tag;
        do n = 2 * n + (1 & o), o >>>= 1, ++a, r += t.table[a], n -= t.table[a]; while (n >= 0);
      ...
      function C(e, t, r) {
        for (;;) {
          ...
          if (i < 256) e.dest[e.destLen++] = i;
            ...
            for (i -= 257, n = E(e, g[i], m[i]), a = R(e, r), s = o = e.destLen - E(e, y[a], b[a]); s < o + n; ++s) e.dest[e.destLen++] = e.dest[s]
        }
      }
      for (o = 0; o < 7; ++o) d.table[o] = 0;
      for (o = 0, d.table[7] = 24, d.table[8] = 152, d.table[9] = 112; o < 24; ++o) d.trans[o] = 256 + o;
      for (o = 0; o < 144; ++o) d.trans[24 + o] = o;
      for (o = 0; o < 8; ++o) d.trans[168 + o] = 280 + o;
      for (o = 0; o < 112; ++o) d.trans[176 + o] = 144 + o;
      for (o = 0; o < 5; ++o) v.table[o] = 0;
      for (o = 0, v.table[5] = 32; o < 32; ++o) v.trans[o] = o;
      T(g, m, 4, 3), T(y, b, 2, 1), g[28] = 0, m[28] = 258;
      var L = function(e, t) {
        var r, n, a = new f(e, t);
        do {
          switch (r = function(e) {
            ...
            case 2:
              ! function(e, t, r) {
                for (s = 0, n = E(e, 5, 257), a = E(e, 5, 1), o = E(e, 4, 4); s < 19; ++s) k[s] = 0;
                for (s = 0; s < o; ++s) {
                  var n, a, o, s, i, u, p = E(e, 3, 0);
                  k[x[s]] = p
                }
                for (O(S, k, 0, 19), i = 0; i < n + a;) {
                  var l = R(e, S);
                  switch (l) {
                    case 16:
                      var c = k[i - 1];
                      for (u = E(e, 2, 3); u; --u) k[i++] = c;
                      break;
                    case 17:
                      for (u = E(e, 3, 3); u; --u) k[i++] = 0;
                      break;
                    case 18:
                      for (u = E(e, 7, 11); u; --u) k[i++] = 0;
                      break;
                    default:
                      k[i++] = l
                  }
                ...
                O(t, k, 0, n), O(r, k, n, a)
              }(a, a.ltree, a.dtree), n = C(a, a.ltree, a.dtree);
              break;
            default:
              n = -3
          }
        ...
        if (a.destLen < a.dest.length)
          if ("function" == typeof a.dest.slice) return a.dest.slice(0, a.destLen);
          else return a.dest.subarray(0, a.destLen);
        return a.dest
      };
      ...
      w.prototype.isEmpty = function() {
        ...
        for (var h = 0; h <= 1; h++) {
          ...
          if (0 === d) {
            if (0 === f) continue;
            var g = -v / f;
            0 < g && g < 1 && (0 === h && this.addX(D(u[h], p[h], l[h], c[h], g)), 1 === h && this.addY(D(u[h], p[h], l[h], c[h], g)));
            continue
          }
          var m = Math.pow(f, 2) - 4 * v * d;
          if (!(m < 0)) {
            var y = (-f + Math.sqrt(m)) / (2 * d);
            0 < y && y < 1 && (0 === h && this.addX(D(u[h], p[h], l[h], c[h], y)), 1 === h && this.addY(D(u[h], p[h], l[h], c[h], y)));
            var b = (-f - Math.sqrt(m)) / (2 * d);
            0 < b && b < 1 && (0 === h && this.addX(D(u[h], p[h], l[h], c[h], b)), 1 === h && this.addY(D(u[h], p[h], l[h], c[h], b)))
          }
        }
      ...
      }, I.prototype.curveTo = I.prototype.bezierCurveTo = function(e, t, r, n, a, o) {
        this.commands.push({
          type: "C",
          x1: e,
          y1: t,
        ...
        for (var e = new w, t = 0, r = 0, n = 0, a = 0, o = 0; o < this.commands.length; o++) {
        ...
        for (var r = "", n = 0; n < this.commands.length; n += 1) {
          ...
          "M" === a.type ? r += "M" + t(a.x, a.y) : "L" === a.type ? r += "L" + t(a.x, a.y) : "C" === a.type ? r += "C" + t(a.x1, a.y1, a.x2, a.y2, a.x, a.y) : "Q" === a.type ? r += "Q" + t(a.x1, a.y1, a.x, a.y) : "Z" === a.type && (r += "Z")
        }
        return r
      ...
      B.BYTE = function(e) {
        return M(e >= 0 && e <= 255, "Byte value should be between 0 and 255."), [e]
      }, A.BYTE = F(1), B.CHAR = function(e) {
        return [e.charCodeAt(0)]
      }, A.CHAR = F(1), B.CHARARRAY = function(e) {
      ...
      }, A.USHORT = F(2), B.SHORT = function(e) {
        return e >= 32768 && (e = -(65536 - e)), [e >> 8 & 255, 255 & e]
      }, A.SHORT = F(2), B.UINT24 = function(e) {
        return [e >> 16 & 255, e >> 8 & 255, 255 & e]
      }, A.UINT24 = F(3), B.ULONG = function(e) {
        return [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e]
      }, A.ULONG = F(4), B.LONG = function(e) {
        return e >= 0x80000000 && (e = -(0x100000000 - e)), [e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e]
      }, A.LONG = F(4), B.FIXED = B.ULONG, A.FIXED = A.ULONG, B.FWORD = B.SHORT, A.FWORD = A.SHORT, B.UFWORD = B.USHORT, A.UFWORD = A.USHORT, B.LONGDATETIME = function(e) {
        return [0, 0, 0, 0, e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e]
      }, A.LONGDATETIME = F(8), B.TAG = function(e) {
        return M(4 === e.length, "Tag should be exactly 4 ASCII characters."), [e.charCodeAt(0), e.charCodeAt(1), e.charCodeAt(2), e.charCodeAt(3)]
      }, A.TAG = F(4), B.Card8 = B.BYTE, A.Card8 = A.BYTE, B.Card16 = B.USHORT, A.Card16 = A.USHORT, B.OffSize = B.BYTE, A.OffSize = A.BYTE, B.SID = B.USHORT, A.SID = A.USHORT, B.NUMBER = function(e) {
        return e >= -107 && e <= 107 ? [e + 139] : e >= 108 && e <= 1131 ? [((e -= 108) >> 8) + 247, 255 & e] : e >= -1131 && e <= -108 ? [((e = -e - 108) >> 8) + 251, 255 & e] : e >= -32768 && e <= 32767 ? B.NUMBER16(e) : B.NUMBER32(e)
      }, A.NUMBER = function(e) {
        return B.NUMBER(e).length
      }, B.NUMBER16 = function(e) {
        return [28, e >> 8 & 255, 255 & e]
      }, A.NUMBER16 = F(3), B.NUMBER32 = function(e) {
        return [29, e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, 255 & e]
      }, A.NUMBER32 = F(5), B.REAL = function(e) {
        var t = e.toString(),
      ...
      }, B.NAME = B.CHARARRAY, A.NAME = A.CHARARRAY, B.STRING = B.CHARARRAY, A.STRING = A.CHARARRAY, G.UTF8 = function(e, t, r) {
      ...
      var P = "function" == typeof WeakMap && new WeakMap,
        H = function(e) {
          if (!s)
            for (var t in s = {}, N) s[t] = new String(t);
          var r = s[e];
          if (void 0 !== r) {
            if (P) {
              var n = P.get(r);
      ...
      B.MACSTRING = function(e, t) {
        ...
        var r = [];
        if (Array.isArray(t))
          for (var n = 0; n < t.length; n += 1) M(e.length === t.length, "Not enough arguments given for type" + t), r = r.concat(B.OPERAND(e[n], t[n]));
      ...
      function Y(e) {
        1 === e.format ? q.call(this, "coverageTable", [{
          ...
          type: "USHORT",
          value: 1
        }].concat(_("glyph", e.glyphs))) : 2 === e.format ? q.call(this, "coverageTable", [{
          name: "coverageFormat",
          type: "USHORT",
          value: 2
        }].concat(V("rangeRecord", e.ranges, function(e) {
          return [{
            name: "startGlyphID",
            type: "USHORT",
            value: e.start
        ...
        }))) : M(!1, "Coverage format must be 1 or 2.")
      }

      function j(e) {
        q.call(this, "scriptListTable", V("scriptRecord", e, function(e, t) {
          var r = e.script,
            n = r.defaultLangSys;
          return M(!!n, "Unable to write GSUB: script " + e.tag + " has no default language system."), [{
            name: "scriptTag" + t,
            type: "TAG",
            value: e.tag
          }, {
            ...
            }].concat(V("langSys", r.langSysRecords, function(e, t) {
              var r = e.langSys;
              return [{
                name: "langSysTag" + t,
                type: "TAG",
      ...
      function Z(e) {
        q.call(this, "featureListTable", V("featureRecord", e, function(e, t) {
          var r = e.feature;
          return [{
            name: "featureTag" + t,
            type: "TAG",
            ...
            }].concat(_("lookupListIndex", r.lookupListIndexes)))
          }]
        }))
      }

      function Q(e, t) {
        q.call(this, "lookupListTable", X("lookup", e, function(e) {
          var r = t[e.lookupType];
          return M(!!r, "Unable to write GSUB lookup type " + e.lookupType + " tables."), new q("lookupTable", [{
            name: "lookupType",
            type: "USHORT",
            value: e.lookupType
          }, {
      ...
      B.CHARSTRING = function(e) {
        ...
        var t = B[e.type];
        return M(void 0 !== t, "No encoding function for type " + e.type), t(e.value)
      }, A.OBJECT = function(e) {
        var t = A[e.type];
        return M(void 0 !== t, "No sizeOf function for type " + e.type), t(e.value)
      }, B.TABLE = function(e) {
        for (var t = [], r = e.fields.length, n = [], a = [], o = 0; o < r; o += 1) {
          var s = e.fields[o],
            i = B[s.type];
          M(void 0 !== i, "No encoding function for field type " + s.type + " (" + s.name + ")");
          var u = e[s.name];
          void 0 === u && (u = s.value);
          var p = i(u);
        ...
        for (var l = 0; l < n.length; l += 1) {
          var c = a[l],
            h = t.length;
          M(h < 65536, "Table " + e.tableName + " too big."), t[c] = h >> 8, t[c + 1] = 255 & h, t = t.concat(n[l])
        }
        return t
      }, A.TABLE = function(e) {
        for (var t = 0, r = e.fields.length, n = 0; n < r; n += 1) {
          var a = e.fields[n],
            o = A[a.type];
          M(void 0 !== o, "No sizeOf function for field type " + a.type + " (" + a.name + ")");
          var s = e[a.name];
          void 0 === s && (s = a.value), t += o(s), "TABLE" === a.type && (t += 2)
        }
        return t
      }, B.RECORD = B.TABLE, A.RECORD = A.TABLE, B.LITERAL = function(e) {
        return e
        ...
        return A.TABLE(this)
      }, Y.prototype = Object.create(q.prototype), Y.prototype.constructor = Y, j.prototype = Object.create(q.prototype), j.prototype.constructor = j, Z.prototype = Object.create(q.prototype), Z.prototype.constructor = Z, Q.prototype = Object.create(q.prototype), Q.prototype.constructor = Q;
      ...
      et.prototype.parseByte = function() {
        var e = this.data.getUint8(this.offset + this.relativeOffset);
        return this.relativeOffset += 1, e
      }, et.prototype.parseChar = function() {
        var e = this.data.getInt8(this.offset + this.relativeOffset);
        return this.relativeOffset += 1, e
      }, et.prototype.parseCard8 = et.prototype.parseByte, et.prototype.parseUShort = function() {
        var e = this.data.getUint16(this.offset + this.relativeOffset);
        return this.relativeOffset += 2, e
      }, et.prototype.parseCard16 = et.prototype.parseUShort, et.prototype.parseSID = et.prototype.parseUShort, et.prototype.parseOffset16 = et.prototype.parseUShort, et.prototype.parseShort = function() {
        var e = this.data.getInt16(this.offset + this.relativeOffset);
        return this.relativeOffset += 2, e
      }, et.prototype.parseF2Dot14 = function() {
        var e = this.data.getInt16(this.offset + this.relativeOffset) / 16384;
        return this.relativeOffset += 2, e
      }, et.prototype.parseULong = function() {
        var e = $(this.data, this.offset + this.relativeOffset);
        return this.relativeOffset += 4, e
      }, et.prototype.parseOffset32 = et.prototype.parseULong, et.prototype.parseFixed = function() {
        var e, t, r = (e = this.data, t = this.offset + this.relativeOffset, e.getInt16(t, !1) + e.getUint16(t + 2, !1) / 65535);
        return this.relativeOffset += 4, r
      }, et.prototype.parseString = function(e) {
        var t = this.data,
        ...
        return n
      }, et.prototype.parseTag = function() {
        return this.parseString(4)
      }, et.prototype.parseLongDateTime = function() {
        var e = $(this.data, this.offset + this.relativeOffset + 4);
        return e -= 0x7c25b080, this.relativeOffset += 8, e
      }, et.prototype.parseVersion = function(e) {
        var t = J(this.data, this.offset + this.relativeOffset),
          r = J(this.data, this.offset + this.relativeOffset + 2);
        return this.relativeOffset += 4, void 0 === e && (e = 4096), t + r / e / 10
      }, et.prototype.skip = function(e, t) {
        void 0 === t && (t = 1), this.relativeOffset += ee[e] * t
      }, et.prototype.parseULongList = function(e) {
      ...
      }, et.prototype.parseOffset16List = et.prototype.parseUShortList = function(e) {
        ...
        return r
      }, et.prototype.parseRecordList32 = function(e, t) {
        t || (t = e, e = this.parseULong());
        for (var r = Array(e), n = Object.keys(t), a = 0; a < e; a++) {
          for (var o = {}, s = 0; s < n.length; s++) {
            var i = n[s],
        ...
        return r
      }, et.prototype.parseStruct = function(e) {
        ...
        return r
      }, et.prototype.parseValueRecord = function(e) {
      ...
      }, et.prototype.parseValueRecordList = function() {
        for (var e = this.parseUShort(), t = this.parseUShort(), r = Array(t), n = 0; n < t; n++) r[n] = this.parseValueRecord(e);
        return r
      }, et.prototype.parsePointer = function(e) {
        var t = this.parseOffset16();
        if (t > 0) return new et(this.data, this.offset + t).parseStruct(e)
      }, et.prototype.parsePointer32 = function(e) {
        var t = this.parseOffset32();
        if (t > 0) return new et(this.data, this.offset + t).parseStruct(e)
      }, et.prototype.parseListOfLists = function(e) {
      ...
      }, et.prototype.parseCoverage = function() {
        ...
        if (2 === t) {
          for (var n = Array(r), a = 0; a < r; a++) n[a] = {
      ...
      }, et.prototype.parseClassDef = function() {
        var e = this.offset + this.relativeOffset,
          t = this.parseUShort();
        if (1 === t) return {
          format: 1,
      ...
      }, et.list = function(e, t) {
        return function() {
          return this.parseList(e, t)
        }
      }, et.list32 = function(e, t) {
        return function() {
          return this.parseList32(e, t)
        }
      }, et.recordList = function(e, t) {
        return function() {
          return this.parseRecordList(e, t)
        }
      }, et.recordList32 = function(e, t) {
        return function() {
          return this.parseRecordList32(e, t)
        }
      }, et.pointer = function(e) {
        return function() {
          return this.parsePointer(e)
        }
      }, et.pointer32 = function(e) {
        return function() {
          return this.parsePointer32(e)
        }
      }, et.tag = et.prototype.parseTag, et.byte = et.prototype.parseByte, et.uShort = et.offset16 = et.prototype.parseUShort, et.uShortList = et.prototype.parseUShortList, et.uLong = et.offset32 = et.prototype.parseULong, et.uLongList = et.prototype.parseULongList, et.struct = et.prototype.parseStruct, et.coverage = et.prototype.parseCoverage, et.classDef = et.prototype.parseClassDef;
      var er = {
        reserved: et.uShort,
        reqFeatureIndex: et.uShort,
        featureIndexes: et.uShortList
      };
      et.prototype.parseScriptList = function() {
        return this.parsePointer(et.recordList({
          tag: et.tag,
          script: et.pointer({
            defaultLangSys: et.pointer(er),
            langSysRecords: et.recordList({
              tag: et.tag,
              langSys: et.pointer(er)
            })
          })
        })) || []
      }, et.prototype.parseFeatureList = function() {
        return this.parsePointer(et.recordList({
          tag: et.tag,
          feature: et.pointer({
            featureParams: et.offset16,
            lookupListIndexes: et.uShortList
          })
        })) || []
      }, et.prototype.parseLookupList = function(e) {
        return this.parsePointer(et.list(et.pointer(function() {
          var t = this.parseUShort();
          M(1 <= t && t <= 9, "GPOS/GSUB lookup type " + t + " unknown.");
          var r = this.parseUShort();
          return {
            lookupType: t,
            lookupFlag: r,
            subtables: this.parseList(et.pointer(e[t])),
            markFilteringSet: 16 & r ? this.parseUShort() : void 0
          }
        }))) || []
      }, et.prototype.parseFeatureVariationsList = function() {
        return this.parsePointer32(function() {
          var e = this.parseUShort(),
            t = this.parseUShort();
          return M(1 === e && t < 1, "GPOS/GSUB feature variations table unknown."), this.parseRecordList32({
            conditionSetOffset: et.offset32,
            featureTableSubstitutionOffset: et.offset32
          })
        }) || []
      };
      var en = function(e, t) {
        ...
        ei = function(e, t) {
          var r = {};
          r.version = J(e, t), M(0 === r.version, "cmap table version should be 0."), r.numTables = J(e, t + 2);
          ...
          if (r.format = i.parseUShort(), 12 === r.format) ! function(e, t) {
            ...
            for (var r, n = 0; n < r; n += 1)
              for (var a = t.parseULong(), o = t.parseULong(), s = t.parseULong(), i = a; i <= o; i += 1) e.glyphIndexMap[i] = s, s++
          }(r, i);
          else if (4 === r.format) ! function(e, t, r, n, a) {
            e.length = t.parseUShort(), e.language = t.parseUShort(), e.segCount = o = t.parseUShort() >> 1, t.skip("uShort", 3), e.glyphIndexMap = {};
            for (var o, s = new et(r, n + a + 14), i = new et(r, n + a + 16 + 2 * o), u = new et(r, n + a + 16 + 4 * o), p = new et(r, n + a + 16 + 6 * o), l = n + a + 16 + 8 * o, c = 0; c < o - 1; c += 1)
              for (var h = void 0, f = s.parseUShort(), d = i.parseUShort(), v = u.parseShort(), g = p.parseUShort(), m = d; m <= f; m += 1) 0 !== g ? 0 !== (h = J(r, l = p.offset + p.relativeOffset - 2 + g + (m - d) * 2)) && (h = h + v & 65535) : h = m + v & 65535, e.glyphIndexMap[m] = h
          }(r, i, e, t, n);
        ...
        eu = function(e) {
          ...
          for (t = 0, a.segments = []; t < e.length; t += 1) {
            for (var o, s, i = e.get(t), u = 0; u < i.unicodes.length; u += 1) o = i.unicodes[u], s = t, a.segments.push({
              end: o,
              start: o,
              delta: -(o - s),
              offset: 0,
          ...
          for (t = 0; t < p; t += 1) {
            var m = a.segments[t];
            m.end <= 65535 && m.start <= 65535 ? (c = c.concat({
              name: "end_" + t,
              type: "USHORT",
              value: m.end
            }), h = h.concat({
              ...
              type: "USHORT",
              value: m.offset
            }), void 0 !== m.glyphId && (v = v.concat({
              name: "glyph_" + t,
              type: "USHORT",
              value: m.glyphId
            }))) : l += 1, r || void 0 === m.glyphIndex || (g = (g = (g = g.concat({
              name: "cmap12Start_" + t,
              type: "ULONG",
              value: m.start
            })).concat({
          ...
          if (a.segCountX2 = (p - l) * 2, a.searchRange = 2 * Math.pow(2, Math.floor(Math.log(p - l) / Math.log(2))), a.entrySelector = Math.log(a.searchRange / 2) / Math.log(2), a.rangeShift = a.segCountX2 - a.searchRange, a.fields = a.fields.concat(c), a.fields.push({
              name: "reservedPad",
              type: "USHORT",
              value: 0
            }), a.fields = a.fields.concat(h), a.fields = a.fields.concat(f), a.fields = a.fields.concat(d), a.fields = a.fields.concat(v), a.cmap4Length = 14 + 2 * c.length + 2 + 2 * h.length + 2 * f.length + 2 * d.length + 2 * v.length, !r) {
            var y = 16 + 4 * g.length;
      ...
      function eg(e) {
        switch (e.version) {
          ...
          case 2:
            ...
            for (var t = 0; t < e.numberOfGlyphs; t++) e.glyphNameIndex[t] < eh.length ? this.names[t] = eh[e.glyphNameIndex[t]] : this.names[t] = e.names[e.glyphNameIndex[t] - eh.length];
            break;
          case 2.5:
            this.names = Array(e.numberOfGlyphs);
            for (var r = 0; r < e.numberOfGlyphs; r++) this.names[r] = eh[r + e.glyphNameIndex[r]];
            break;
          default:
            this.names = []
        }
      ...
      }, ev.prototype.charToGlyphIndex = function(e) {
        var t = e.codePointAt(0),
          r = this.encoding[t];
      ...
      ey.prototype.bindConstructorValues = function(e) {
        var t;
        this.index = e.index || 0, this.name = e.name || null, this.unicode = e.unicode || void 0, this.unicodes = e.unicodes || void 0 !== e.unicode ? [e.unicode] : [], "xMin" in e && (this.xMin = e.xMin), "yMin" in e && (this.yMin = e.yMin), "xMax" in e && (this.xMax = e.xMax), "yMax" in e && (this.yMax = e.yMax), "advanceWidth" in e && (this.advanceWidth = e.advanceWidth), Object.defineProperty(this, "path", (t = e.path || new I, {
          configurable: !0,
          get: function() {
      ...
      }, ey.prototype.addUnicode = function(e) {
        0 === this.unicodes.length && (this.unicode = e), this.unicodes.push(e)
      }, ey.prototype.getBoundingBox = function() {
        return this.path.getBoundingBox()
      }, ey.prototype.getPath = function(e, t, r, n, a) {
        ...
        for (var l = new I, c = 0; c < o.length; c += 1) {
          var h = o[c];
          "M" === h.type ? l.moveTo(e + h.x * i, t + -h.y * u) : "L" === h.type ? l.lineTo(e + h.x * i, t + -h.y * u) : "Q" === h.type ? l.quadraticCurveTo(e + h.x1 * i, t + -h.y1 * u, e + h.x * i, t + -h.y * u) : "C" === h.type ? l.curveTo(e + h.x1 * i, t + -h.y1 * u, e + h.x2 * i, t + -h.y2 * u, e + h.x * i, t + -h.y * u) : "Z" === h.type && l.closePath()
        }
        return l
      }, ey.prototype.getContours = function() {
        if (void 0 === this.points) return [];
        for (var e = [], t = [], r = 0; r < this.points.length; r += 1) {
          var n = this.points[r];
          t.push(n), n.lastPointOfContour && (e.push(t), t = [])
        }
        return M(0 === t.length, "There are still points left in the current contour."), e
      }, ey.prototype.getMetrics = function() {
      ...
      }, ey.prototype.draw = function(e, t, r, n, a) {
        this.getPath(t, r, n, a).draw(e)
      }, ey.prototype.drawPoints = function(e, t, r, n) {
        function a(t, r, n, a) {
          e.beginPath();
      ...
      }, ey.prototype.drawMetrics = function(e, t, r, n) {
        t = void 0 !== t ? t : 0, r = void 0 !== r ? r : 0, n = void 0 !== n ? n : 24, a = 1 / this.path.unitsPerEm * n, e.lineWidth = 1, e.strokeStyle = "black", em(e, t, -1e4, t, 1e4), em(e, -1e4, r, 1e4, r);
        var a, o = this.xMin || 0,
          s = this.yMin || 0,
          i = this.xMax || 0,
          u = this.yMax || 0,
          p = this.advanceWidth || 0;
        e.strokeStyle = "blue", em(e, t + o * a, -1e4, t + o * a, 1e4), em(e, t + i * a, -1e4, t + i * a, 1e4), em(e, -1e4, r + -s * a, 1e4, r + -s * a), em(e, -1e4, r + -u * a, 1e4, r + -u * a), e.strokeStyle = "green", em(e, t + p * a, -1e4, t + p * a, 1e4)
      ...
      var eS = function(e, t) {
        ...
        ek = function(e, t, r, n, a, o) {
          return function() {
            ...
            }, eb(s, "xMin", "_xMin"), eb(s, "xMax", "_xMax"), eb(s, "yMin", "_yMin"), eb(s, "yMax", "_yMax"), s
          }
        },
        eT = function(e, t, r, n) {
          return function() {
      ...
      function eO(e, t, r) {
        ...
        if (0 !== i) {
          var u = K(e, t + 2);
          n = t + (i + 1) * u + 2;
          for (var p = t + 3, l = 0; l < i + 1; l += 1) o.push(ea(e, p, u)), p += u;
          a = n + o[i]
        } else a = t + 2;
        for (var c = 0; c < o.length - 1; c += 1) {
          var h = eo(e, n + o[c], n + o[c + 1]);
          r && (h = r(h)), s.push(h)
        }
        return {
          objects: s,
      ...
      function eE(e, t, r) {
        var n = new et(e, t = void 0 !== t ? t : 0),
          a = [],
          o = [];
        for (r = void 0 !== r ? r : e.length; n.relativeOffset < r;) {
          var s = n.parseByte();
          s <= 21 ? (12 === s && (s = 1200 + n.parseByte()), a.push([s, o]), o = []) : o.push(function(e, t) {
            var r, n;
            if (28 === t) return (r = e.parseByte()) << 8 | (n = e.parseByte());
            if (29 === t) return r = e.parseByte(), n = e.parseByte(), r << 24 | n << 16 | e.parseByte() << 8 | e.parseByte();
      ...
      function eC(e, t, r) {
        for (var n, a = {}, o = 0; o < t.length; o += 1) {
          ...
          if (Array.isArray(s.type)) {
            ...
            for (var u = 0; u < s.type.length; u++) void 0 === (n = void 0 !== e[s.op] ? e[s.op][u] : void 0) && (n = void 0 !== s.value && void 0 !== s.value[u] ? s.value[u] : null), "SID" === s.type[u] && (n = eR(r, n)), i[u] = n;
            a[s.name] = i
          } else void 0 === (n = e[s.op]) && (n = void 0 !== s.value ? s.value : null), "SID" === s.type && (n = eR(r, n)), a[s.name] = n
        }
        return a
      }
      var eL = [{
      ...
      function ew(e, t, r, n) {
        for (var a = [], o = 0; o < r.length; o += 1) {
          var s = (p = new DataView(new Uint8Array(r[o]).buffer), eC(eE(p, 0, p.byteLength), eL, n));
          s._subrs = [], s._subrsBias = 0, s._defaultWidthX = 0, s._nominalWidthX = 0;
          var i = s.private[0],
            u = s.private[1];
          if (0 !== i && 0 !== u) {
            var p, l = eC(eE(e, u + t, i), eD, n);
            s._defaultWidthX = l.defaultWidthX, s._nominalWidthX = l.nominalWidthX, 0 !== l.subrs && (s._subrs = eO(e, u + l.subrs + t).objects, s._subrsBias = eU(s._subrs)), s._privateDict = l
          }
          a.push(s)
        }
        return a
      ...
      function eI(e, t, r) {
        ...
        function S(e, t) {
          v && c.closePath(), c.moveTo(e, t), v = !0
        }
        ...
        return ! function r(p) {
          for (var y, b, T, U, O, E, R, C, L, D, w, I, M = 0; M < p.length;) {
            var G = p[M];
            switch (M += 1, G) {
              case 1:
              case 3:
              ...
              case 23:
                ...
                break;
              case 4:
                h.length > 1 && !d && (x = h.shift() + l, d = !0), m += h.pop(), S(g, m);
                break;
              case 5:
                for (; h.length > 0;) g += h.shift(), m += h.shift(), c.lineTo(g, m);
                break;
              case 6:
                for (; h.length > 0 && (g += h.shift(), c.lineTo(g, m), 0 !== h.length);) m += h.shift(), c.lineTo(g, m);
                break;
              case 7:
                for (; h.length > 0 && (m += h.shift(), c.lineTo(g, m), 0 !== h.length);) g += h.shift(), c.lineTo(g, m);
                break;
              case 8:
                for (; h.length > 0;) n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s + h.shift(), c.curveTo(n, a, o, s, g, m);
                break;
              case 10:
                (E = i[O = h.pop() + u]) && r(E);
                break;
              ...
              case 12:
                switch (G = p[M], M += 1, G) {
                  case 35:
                    n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), R = o + h.shift(), C = s + h.shift(), L = R + h.shift(), D = C + h.shift(), w = L + h.shift(), I = D + h.shift(), g = w + h.shift(), m = I + h.shift(), h.shift(), c.curveTo(n, a, o, s, R, C), c.curveTo(L, D, w, I, g, m);
                    break;
                  case 34:
                    n = g + h.shift(), a = m, o = n + h.shift(), s = a + h.shift(), R = o + h.shift(), C = s, L = R + h.shift(), D = s, w = L + h.shift(), I = m, g = w + h.shift(), c.curveTo(n, a, o, s, R, C), c.curveTo(L, D, w, I, g, m);
                    break;
                  case 36:
                    n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), R = o + h.shift(), C = s, L = R + h.shift(), D = s, w = L + h.shift(), I = D + h.shift(), g = w + h.shift(), c.curveTo(n, a, o, s, R, C), c.curveTo(L, D, w, I, g, m);
                    break;
                  case 37:
                    n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), R = o + h.shift(), C = s + h.shift(), L = R + h.shift(), D = C + h.shift(), w = L + h.shift(), I = D + h.shift(), Math.abs(w - g) > Math.abs(I - m) ? g = w + h.shift() : m = I + h.shift(), c.curveTo(n, a, o, s, R, C), c.curveTo(L, D, w, I, g, m);
                    break;
                  default:
                ...
                break;
              case 14:
                h.length > 0 && !d && (x = h.shift() + l, d = !0), v && (c.closePath(), v = !1);
                break;
              case 19:
              case 20:
                k(), M += f + 7 >> 3;
                break;
              case 21:
                h.length > 2 && !d && (x = h.shift() + l, d = !0), m += h.pop(), S(g += h.pop(), m);
                break;
              case 22:
                h.length > 1 && !d && (x = h.shift() + l, d = !0), S(g += h.pop(), m);
                break;
              case 24:
                for (; h.length > 2;) n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s + h.shift(), c.curveTo(n, a, o, s, g, m);
                g += h.shift(), m += h.shift(), c.lineTo(g, m);
                break;
              case 25:
                for (; h.length > 6;) g += h.shift(), m += h.shift(), c.lineTo(g, m);
                n = g + h.shift(), a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s + h.shift(), c.curveTo(n, a, o, s, g, m);
                break;
              case 26:
                for (h.length % 2 && (g += h.shift()); h.length > 0;) n = g, a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o, m = s + h.shift(), c.curveTo(n, a, o, s, g, m);
                break;
              case 27:
                for (h.length % 2 && (m += h.shift()); h.length > 0;) n = g + h.shift(), a = m, o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s, c.curveTo(n, a, o, s, g, m);
                break;
              case 28:
              ...
              case 29:
                ...
                break;
              case 30:
                for (; h.length > 0 && (n = g, a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s + (1 === h.length ? h.shift() : 0), c.curveTo(n, a, o, s, g, m), 0 !== h.length);) n = g + h.shift(), a = m, o = n + h.shift(), m = (s = a + h.shift()) + h.shift(), g = o + (1 === h.length ? h.shift() : 0), c.curveTo(n, a, o, s, g, m);
                break;
              case 31:
                for (; h.length > 0 && (n = g + h.shift(), a = m, o = n + h.shift(), m = (s = a + h.shift()) + h.shift(), g = o + (1 === h.length ? h.shift() : 0), c.curveTo(n, a, o, s, g, m), 0 !== h.length);) n = g, a = m + h.shift(), o = n + h.shift(), s = a + h.shift(), g = o + h.shift(), m = s + (1 === h.length ? h.shift() : 0), c.curveTo(n, a, o, s, g, m);
                break;
              default:
                G < 32 ? console.log("Glyph " + t.index + ": unknown operator " + G) : G < 247 ? h.push(G - 139) : G < 251 ? (y = p[M], M += 1, h.push((G - 247) * 256 + y + 108)) : G < 255 ? (y = p[M], M += 1, h.push(-(256 * (G - 251)) - y - 108)) : (y = p[M], b = p[M + 1], T = p[M + 2], U = p[M + 3], M += 4, h.push((y << 24 | b << 16 | T << 8 | U) / 65536))
            }
          }
      ...
      function eM(e, t) {
        var r, n = ep.indexOf(e);
        return n >= 0 && (r = n), (n = t.indexOf(e)) >= 0 ? r = n + ep.length : (r = ep.length + t.length, t.push(e)), r
      }
      ...
      function eG(e, t, r) {
        for (var n = {}, a = 0; a < e.length; a += 1) {
          ...
          void 0 !== s && ! function e(t, r) {
            ...
            return !0
          }(s, o.value) && ("SID" === o.type && (s = eM(s, r)), n[o.op] = {
            name: o.name,
            type: o.type,
            value: s
          })
      ...
      function eB(e, t) {
        var r = new q("Top DICT", [{
          name: "dict",
          type: "DICT",
          value: {}
        }]);
        return r.dict = eG(eL, e, t), r
      }

      function eA(e) {
        var t = new q("Top DICT INDEX", [{
          name: "topDicts",
          type: "INDEX",
          value: []
        }]);
      ...
      var eF = function(e, t, r, n) {
          r.tables.cff = {};
          var a, o, s, i, u = ((s = {}).formatMajor = K(e, t), s.formatMinor = K(e, t + 1), s.size = K(e, t + 2), s.offsetSize = K(e, t + 3), s.startOffset = t, s.endOffset = t + 4, s),
            p = eO(e, u.endOffset, es),
            l = eO(e, p.endOffset),
            c = eO(e, l.endOffset, es);
          r.gsubrs = eO(e, c.endOffset).objects, r.gsubrsBias = eU(r.gsubrs);
          var h = ew(e, t, l.objects, c.objects);
          if (1 !== h.length) throw Error("CFF table has too many fonts in 'FontSet' - count of fonts NameIndex.length = " + h.length);
          var f = h[0];
          if (r.tables.cff.topDict = f, f._privateDict && (r.defaultWidthX = f._privateDict.defaultWidthX, r.nominalWidthX = f._privateDict.nominalWidthX), void 0 !== f.ros[0] && void 0 !== f.ros[1] && (r.isCIDFont = !0), r.isCIDFont) {
            var d = f.fdArray,
              v = f.fdSelect;
            if (0 === d || 0 === v) throw Error("Font is marked as a CID font, but FDArray and/or FDSelect information is missing");
            var g = eO(e, d += t),
              m = ew(e, t, g.objects, c.objects);
            f._fdArray = m, f._fdSelect = function(e, t, r, n) {
              var a = [],
                o = new et(e, t),
                s = o.parseCard8();
              if (0 === s)
              ...
              return a
            }(e, v += t, r.numGlyphs, m.length)
          }
          var y = t + f.private[1],
            b = (a = f.private[0], o = c.objects, eC(eE(e, y, a), eD, o));
          r.defaultWidthX = b.defaultWidthX, r.nominalWidthX = b.nominalWidthX, 0 !== b.subrs ? (r.subrs = eO(e, y + b.subrs).objects, r.subrsBias = eU(r.subrs)) : (r.subrs = [], r.subrsBias = 0), n.lowMemory ? r.nGlyphs = (i = function(e, t) {
            var r, n, a = [],
              o = J(e, t);
            if (0 !== o) {
              var s = K(e, t + 2);
              r = t + (o + 1) * s + 2;
              for (var i = t + 3, u = 0; u < o + 1; u += 1) a.push(ea(e, i, s)), i += s;
              n = r + a[o]
            } else n = t + 2;
            return {
              offsets: a,
          ...
          }(e, t + f.charStrings)).offsets.length : r.nGlyphs = (i = eO(e, t + f.charStrings)).objects.length;
          var x = function(e, t, r, n) {
            var a, o, s = new et(e, t);
            r -= 1;
            var i = [".notdef"],
              u = s.parseCard8();
            if (0 === u)
              for (var p = 0; p < r; p += 1) a = s.parseSID(), i.push(eR(n, a));
            else if (1 === u)
              for (; i.length <= r;) {
                a = s.parseSID(), o = s.parseCard8();
                for (var l = 0; l <= o; l += 1) i.push(eR(n, a)), a += 1
              } else if (2 === u)
                for (; i.length <= r;) {
                  a = s.parseSID(), o = s.parseCard16();
                  for (var c = 0; c <= o; c += 1) i.push(eR(n, a)), a += 1
                } else throw Error("Unknown charset format " + u);
            return i
          }(e, t + f.charset, r.nGlyphs, c.objects);
          if (0 === f.encoding ? r.cffEncoding = new ev(el, x) : 1 === f.encoding ? r.cffEncoding = new ev(ec, x) : r.cffEncoding = function(e, t, r) {
              var n, a = {},
                o = new et(e, t),
                s = o.parseCard8();
              if (0 === s)
                for (var i = o.parseCard8(), u = 0; u < i; u += 1) a[n = o.parseCard8()] = u;
              else if (1 === s) {
                var p = o.parseCard8();
                n = 1;
                for (var l = 0; l < p; l += 1)
                  for (var c = o.parseCard8(), h = o.parseCard8(), f = c; f <= c + h; f += 1) a[f] = n, n += 1
              } else throw Error("Unknown encoding format " + s);
              return new ev(a, r)
            }(e, t + f.encoding, x), r.encoding = r.encoding || r.cffEncoding, r.glyphs = new ex(r), n.lowMemory) r._push = function(n) {
            var a = function(e, t, r, n, a) {
              ...
              return eo(r, s + t[e], s + t[e + 1])
            }(n, i.offsets, e, t + f.charStrings);
            r.glyphs.push(n, eT(r, n, eI, a))
          };
          else
            for (var S = 0; S < r.nGlyphs; S += 1) {
              var k = i.objects[S];
              r.glyphs.push(S, eT(r, S, eI, k))
            }
        },
        eN = function(e, t) {
          for (var r, n, a, o = new q("CFF ", [{
              name: "header",
              type: "RECORD"
            }, {
              name: "nameIndex",
              ...
              charStrings: 999,
              private: [0, 999]
            }, u = [], p = 1; p < e.length; p += 1) a = e.get(p), u.push(a.name);
          var l = [];
          o.header = new q("Header", [{
            name: "major",
            type: "Card8",
            value: 1
          }, {
          ...
          var c = eB(i, l);
          return o.topDictIndex = eA(c), o.globalSubrIndex = new q("Global Subr INDEX", [{
            name: "subrs",
            type: "INDEX",
            value: []
          }]), o.charsets = function(e, t) {
            for (var r = new q("Charsets", [{
                name: "format",
                type: "Card8",
                value: 0
              }]), n = 0; n < e.length; n += 1) {
            ...
            return r
          }(u, l), o.charStringsIndex = function(e) {
            for (var t = new q("CharStrings INDEX", [{
                name: "charStrings",
                type: "INDEX",
                value: []
              }]), r = 0; r < e.length; r += 1) {
                  ...
                  for (var n = 0, a = 0, o = 0; o < r.commands.length; o += 1) {
                    ...
                    if ("Q" === u.type) {
                      ...
                      u = {
                        ...
                        x: u.x,
                        y: u.y,
                        x1: Math.round(p * n + l * u.x1),
                        y1: Math.round(p * a + l * u.y1),
                        x2: Math.round(p * u.x + l * u.x1),
                        y2: Math.round(p * u.y + l * u.y1)
                      }
                    }
                    ...
                    else if ("L" === u.type) s = Math.round(u.x - n), i = Math.round(u.y - a), t.push({
                      name: "dx",
                      type: "NUMBER",
                      value: s
                    }), t.push({
            ...
            return t
          }(e), r = {}, (n = new q("Private DICT", [{
            name: "dict",
            type: "DICT",
            value: {}
          }])).dict = eG(eD, r, l), o.privateDict = n, o.stringIndex = function(e) {
            var t = new q("String INDEX", [{
              name: "strings",
              type: "INDEX",
              value: []
            }]);
            ...
            return t
          }(l), i.charset = o.header.sizeOf() + o.nameIndex.sizeOf() + o.topDictIndex.sizeOf() + o.stringIndex.sizeOf() + o.globalSubrIndex.sizeOf(), i.encoding = 0, i.charStrings = i.charset + o.charsets.sizeOf(), i.private[1] = i.charStrings + o.charStringsIndex.sizeOf(), o.topDictIndex = eA(c = eB(i, l)), o
        },
        eP = function(e, t) {
          var r = {},
            n = new et(e, t);
          return r.version = n.parseVersion(), r.fontRevision = Math.round(1e3 * n.parseFixed()) / 1e3, r.checkSumAdjustment = n.parseULong(), r.magicNumber = n.parseULong(), M(0x5f0f3cf5 === r.magicNumber, "Font header has wrong magic number."), r.flags = n.parseUShort(), r.unitsPerEm = n.parseUShort(), r.created = n.parseLongDateTime(), r.modified = n.parseLongDateTime(), r.xMin = n.parseShort(), r.yMin = n.parseShort(), r.xMax = n.parseShort(), r.yMax = n.parseShort(), r.macStyle = n.parseUShort(), r.lowestRecPPEM = n.parseUShort(), r.fontDirectionHint = n.parseShort(), r.indexToLocFormat = n.parseShort(), r.glyphDataFormat = n.parseShort(), r
        },
        eH = function(e) {
          var t = Math.round(new Date().getTime() / 1e3) + 0x7c25b080,
            r = t;
          return e.createdTimestamp && (r = e.createdTimestamp + 0x7c25b080), new q("head", [{
            name: "version",
            type: "FIXED",
            value: 65536
          }, {
        ...
        eW = function(e, t, r, n, a, o, s) {
          if (s.lowMemory) {
            e._hmtxTableData = {};
            for (var i, u, p = new et(t, r), l = 0; l < a; l += 1) l < n && (i = p.parseUShort(), u = p.parseShort()), e._hmtxTableData[l] = {
              advanceWidth: i,
              leftSideBearing: u
            }
          } else ! function(e, t, r, n, a) {
            for (var o, s, i = new et(e, t), u = 0; u < n; u += 1) {
        ...
        eq = function(e) {
          for (var t = new q("hmtx", []), r = 0; r < e.length; r += 1) {
            var n = e.get(r),
              a = n.advanceWidth || 0,
        ...
        eX = function(e, t) {
          var r = new et(e, t);
          M(1 === r.parseULong(), "Unsupported ltag table version."), r.skip("uLong", 1);
          for (var n = r.parseULong(), a = [], o = 0; o < n; o++) {
            for (var s = "", i = t + r.parseUShort(), u = r.parseUShort(), p = i; p < i + u; ++p) s += String.fromCharCode(e.getInt8(p));
            a.push(s)
          }
          return a
        },
        ...
        eY = ["copyright", "fontFamily", "fontSubfamily", "uniqueID", "fullName", "version", "postScriptName", "trademark", "manufacturer", "designer", "description", "manufacturerURL", "designerURL", "license", "licenseURL", "reserved", "preferredFamily", "preferredSubfamily", "compatibleFullName", "sampleText", "postScriptFindFontName", "wwsFamily", "wwsSubfamily"],
        ej = {
          0: "en",
          1: "fr",
          2: "de",
      ...
      var e3 = function(e, t, r) {
          for (var n = {}, a = new et(e, t), o = a.parseUShort(), s = a.parseUShort(), i = a.offset + a.parseUShort(), u = 0; u < s; u++) {
            var p = a.parseUShort(),
              l = a.parseUShort(),
              c = a.parseUShort(),
              h = a.parseUShort(),
            ...
            if (void 0 !== m && void 0 !== g) {
              var y = void 0;
              if (y = m === eK ? G.UTF16(e, i + v, d) : G.MACSTRING(e, i + v, d, m)) {
                var b = n[f];
        ...
        e5 = function(e, t) {
          ...
          for (var u = e1(ej), p = e1(eQ), l = [], c = [], h = 0; h < n.length; h++) {
            var f = a[r = n[h]];
            for (var d in f) {
              var v = f[d],
                g = 1,
                ...
                b = e0(g, y, m),
                x = B.MACSTRING(v, b);
              void 0 === x && (g = 0, (m = t.indexOf(d)) < 0 && (m = t.length, t.push(d)), y = 4, x = B.UTF16(v));
              var S = e6(x, c);
              l.push(e2(g, y, m, r, x.length, S));
              var k = p[d];
              if (void 0 !== k) {
                var T = B.UTF16(v),
                  U = e6(T, c);
                l.push(e2(3, 1, k, r, T.length, U))
              }
            }
          }
          l.sort(function(e, t) {
          ...
          for (var O = new q("name", [{
              ...
              type: "USHORT",
              value: 6 + 12 * l.length
            }]), E = 0; E < l.length; E++) O.fields.push({
            name: "record_" + E,
            type: "RECORD",
            value: l[E]
          });
          ...
          switch (r.version = n.parseVersion(), r.italicAngle = n.parseFixed(), r.underlinePosition = n.parseShort(), r.underlineThickness = n.parseShort(), r.isFixedPitch = n.parseULong(), r.minMemType42 = n.parseULong(), r.maxMemType42 = n.parseULong(), r.minMemType1 = n.parseULong(), r.maxMemType1 = n.parseULong(), r.version) {
            ...
            case 2:
              ...
              for (var o = 0; o < r.numberOfGlyphs; o++)
                if (r.glyphNameIndex[o] >= eh.length) {
                  var s = n.parseChar();
      ...
      te[1] = function() {
        ...
        return 1 === t ? {
          substFormat: 1,
          coverage: this.parsePointer(et.coverage),
          deltaGlyphId: this.parseUShort()
        } : 2 === t ? {
          substFormat: 2,
          coverage: this.parsePointer(et.coverage),
          substitute: this.parseOffset16List()
        } : void M(!1, "0x" + e.toString(16) + ": lookup type 1 format must be 1 or 2.")
      }, te[2] = function() {
        var e = this.parseUShort();
        return M(1 === e, "GSUB Multiple Substitution Subtable identifier-format must be 1"), {
          substFormat: e,
          coverage: this.parsePointer(et.coverage),
        ...
        var e = this.parseUShort();
        return M(1 === e, "GSUB Alternate Substitution Subtable identifier-format must be 1"), {
          substFormat: e,
          coverage: this.parsePointer(et.coverage),
        ...
        var e = this.parseUShort();
        return M(1 === e, "GSUB ligature table identifier-format must be 1"), {
          substFormat: e,
          coverage: this.parsePointer(et.coverage),
      ...
      var tt = {
        sequenceIndex: et.uShort,
        lookupListIndex: et.uShort
      };
      te[5] = function() {
        var e = this.offset + this.relativeOffset,
          t = this.parseUShort();
        if (1 === t) return {
          ...
          ruleSets: this.parseListOfLists(function() {
            ...
            return {
              ...
              lookupRecords: this.parseRecordList(t, tt)
            }
          })
        };
        if (2 === t) return {
          substFormat: t,
          coverage: this.parsePointer(et.coverage),
          classDef: this.parsePointer(et.classDef),
        ...
        if (3 === t) {
          ...
          return {
            substFormat: t,
            coverages: this.parseList(r, et.pointer(et.coverage)),
            lookupRecords: this.parseRecordList(n, tt)
          }
        }
        M(!1, "0x" + e.toString(16) + ": lookup type 5 format must be 1, 2 or 3.")
      }, te[6] = function() {
        var e = this.offset + this.relativeOffset,
          t = this.parseUShort();
        return 1 === t ? {
          ...
          chainRuleSets: this.parseListOfLists(function() {
            return {
              ...
              lookupRecords: this.parseRecordList(tt)
            }
          })
        } : 2 === t ? {
          substFormat: 2,
          coverage: this.parsePointer(et.coverage),
          backtrackClassDef: this.parsePointer(et.classDef),
          inputClassDef: this.parsePointer(et.classDef),
          lookaheadClassDef: this.parsePointer(et.classDef),
          ...
          substFormat: 3,
          backtrackCoverage: this.parseList(et.pointer(et.coverage)),
          inputCoverage: this.parseList(et.pointer(et.coverage)),
          lookaheadCoverage: this.parseList(et.pointer(et.coverage)),
          lookupRecords: this.parseRecordList(tt)
        } : void M(!1, "0x" + e.toString(16) + ": lookup type 6 format must be 1, 2 or 3.")
      }, te[7] = function() {
        M(1 === this.parseUShort(), "GSUB Extension Substitution subtable identifier-format must be 1");
        var e = this.parseUShort(),
          t = new et(this.data, this.offset + this.parseULong());
        return {
          substFormat: 1,
          lookupType: e,
          extension: te[e].call(t)
        }
      }, te[8] = function() {
        var e = this.parseUShort();
        return M(1 === e, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"), {
          substFormat: e,
          coverage: this.parsePointer(et.coverage),
          backtrackCoverage: this.parseList(et.pointer(et.coverage)),
          lookaheadCoverage: this.parseList(et.pointer(et.coverage)),
      ...
      var tr = Array(9);
      tr[1] = function(e) {
        return 1 === e.substFormat ? new q("substitutionTable", [{
          name: "substFormat",
          type: "USHORT",
          value: 1
        }, {
          name: "coverage",
          type: "TABLE",
          value: new Y(e.coverage)
        }, {
          name: "deltaGlyphID",
          type: "USHORT",
          value: e.deltaGlyphId
        }]) : new q("substitutionTable", [{
          name: "substFormat",
          type: "USHORT",
          value: 2
        }, {
          ...
          type: "TABLE",
          value: new Y(e.coverage)
        }].concat(_("substitute", e.substitute)))
      }, tr[2] = function(e) {
        return M(1 === e.substFormat, "Lookup type 2 substFormat must be 1."), new q("substitutionTable", [{
          name: "substFormat",
          type: "USHORT",
          value: 1
        }, {
          ...
          type: "TABLE",
          value: new Y(e.coverage)
        }].concat(X("seqSet", e.sequences, function(e) {
          return new q("sequenceSetTable", _("sequence", e))
        })))
      }, tr[3] = function(e) {
        return M(1 === e.substFormat, "Lookup type 3 substFormat must be 1."), new q("substitutionTable", [{
          name: "substFormat",
          type: "USHORT",
          value: 1
        }, {
          ...
          type: "TABLE",
          value: new Y(e.coverage)
        }].concat(X("altSet", e.alternateSets, function(e) {
          return new q("alternateSetTable", _("alternate", e))
        })))
      }, tr[4] = function(e) {
        return M(1 === e.substFormat, "Lookup type 4 substFormat must be 1."), new q("substitutionTable", [{
          name: "substFormat",
          type: "USHORT",
          value: 1
        }, {
          ...
          type: "TABLE",
          value: new Y(e.coverage)
        }].concat(X("ligSet", e.ligatureSets, function(e) {
          return new q("ligatureSetTable", X("ligature", e, function(e) {
            return new q("ligatureTable", [{
              name: "ligGlyph",
              type: "USHORT",
              value: e.ligGlyph
            }].concat(_("component", e.components, e.components.length + 1)))
          }))
        })))
      }, tr[6] = function(e) {
        if (1 === e.substFormat) return new q("chainContextTable", [{
          name: "substFormat",
          type: "USHORT",
          value: e.substFormat
        }, {
          ...
          type: "TABLE",
          value: new Y(e.coverage)
        }].concat(X("chainRuleSet", e.chainRuleSets, function(e) {
          return new q("chainRuleSetTable", X("chainRule", e, function(e) {
            var t = _("backtrackGlyph", e.backtrack, e.backtrack.length).concat(_("inputGlyph", e.input, e.input.length + 1)).concat(_("lookaheadGlyph", e.lookahead, e.lookahead.length)).concat(_("substitution", [], e.lookupRecords.length));
            ...
            }), new q("chainRuleTable", t)
          }))
        })));
        if (2 === e.substFormat) M(!1, "lookup type 6 format 2 is not yet supported.");
          ...
          }), new q("chainContextTable", t)
        }
        M(!1, "lookup type 6 format must be 1, 2 or 3.")
      };
      var tn = function(e, t) {
          var r = new et(e, t = t || 0),
            n = r.parseVersion(1);
          return (M(1 === n || 1.1 === n, "Unsupported GSUB table version."), 1 === n) ? {
            version: n,
        ...
        ta = function(e, t) {
          var r = new et(e, t);
          M(1 === r.parseULong(), "Unsupported META table version."), r.parseULong(), r.parseULong();
          for (var n = r.parseULong(), a = {}, o = 0; o < n; o++) {
            var s = r.parseTag(),
              i = r.parseULong(),
              u = r.parseULong(),
      ...
      var tl = function(e) {
        for (var t, r, n = [], a = [], o = [], s = [], i = [], u = [], p = [], l = 0, c = 0, h = 0, f = 0, d = 0, v = 0; v < e.glyphs.length; v += 1) {
          var g = e.glyphs.get(v),
            m = 0 | g.unicode;
          if (isNaN(g.advanceWidth)) throw Error("Glyph " + g.name + " (" + v + "): advanceWidth is not a number.");
          (r > m || void 0 === r) && m > 0 && (r = m), l < m && (l = m);
          var y = e7(m);
          if (y < 32) c |= 1 << y;
          else if (y < 64) h |= 1 << y - 32;
          else if (y < 96) f |= 1 << y - 64;
          else if (y < 123) d |= 1 << y - 96;
          else throw Error("Unicode ranges bits > 123 are reserved for internal usage");
          if (".notdef" !== g.name) {
            var b = g.getMetrics();
            n.push(b.xMin), a.push(b.yMin), o.push(b.xMax), s.push(b.yMax), u.push(b.leftSideBearing), p.push(b.rightSideBearing), i.push(g.advanceWidth)
          }
        }
        var x = {
          ...
          minLeftSideBearing: Math.min.apply(null, u),
          maxLeftSideBearing: Math.max.apply(null, u),
        ...
        var S = eH({
          ...
          U = new q("OS/2", [{
            ...
            sCapHeight: tp(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", x).yMax,
            usDefaultChar: 32 * !!e.hasChar(" "),
            usBreakChar: 32 * !!e.hasChar(" ")
          }, e.tables.os2)),
          O = eq(e.glyphs),
          E = eu(e.glyphs),
          ...
          L = R + " " + C,
          D = e.getEnglishName("postScriptName");
        D || (D = R.replace(/\s/g, "") + "-" + C);
        var w = {};
        for (var I in e.names) w[I] = e.names[I];
        ...
        var G = [],
          ...
          P = e.metas && Object.keys(e.metas).length > 0 ? to(e.metas) : void 0,
          H = [S, k, T, U, B, E, F, N, O];
        A && H.push(A), e.tables.gsub && H.push(new q("GSUB", [{
          name: "version",
          type: "ULONG",
          value: 65536
        }, {
          name: "scripts",
          type: "TABLE",
          value: new j((t = e.tables.gsub).scripts)
        }, {
          name: "features",
          type: "TABLE",
          value: new Z(t.features)
        }, {
          name: "lookups",
          type: "TABLE",
          value: new Q(t.lookups, tr)
        }])), P && H.push(P);
        for (var z = function(e) {
            ...
            var r = Math.pow(2, ts(t.numTables));
            t.searchRange = 16 * r, t.entrySelector = ts(r), t.rangeShift = 16 * t.numTables - t.searchRange;
            for (var n = [], a = [], o = t.sizeOf() + tu().sizeOf() * t.numTables; o % 4 != 0;) o += 1, a.push({
              name: "padding",
              type: "BYTE",
              value: 0
            });
            for (var s = 0; s < e.length; s += 1) {
              var i = e[s];
              M(4 === i.tableName.length, "Table name" + i.tableName + " is invalid.");
              var u = i.sizeOf(),
                p = tu(i.tableName, ti(i.encode()), o, u);
              for (n.push({
                  ...
                  type: "RECORD",
                  value: i
                }), M(!isNaN(o += u), "Something went wrong calculating the offset."); o % 4 != 0;) o += 1, a.push({
                name: "padding",
                type: "BYTE",
                value: 0
              })
          ...
          }(H), W = ti(z.encode()), _ = z.fields, X = !1, V = 0; V < _.length; V += 1)
          if ("head table" === _[V].name) {
            _[V].value.checkSumAdjustment = 0xb1b0afba - W, X = !0;
            break
          } if (!X) throw Error("Could not find head table with checkSum to adjust.");
        return z
      };
      ...
      td.prototype = {
        ...
        getFeatureTable: function(e, t, r, n) {
          ...
          if (a) {
            for (var o, s = a.featureIndexes, i = this.font.tables[this.tableName].features, u = 0; u < s.length; u++)
              if ((o = i[s[u]]).tag === r) return o.feature;
            if (n) {
              var p = i.length;
              return M(0 === p || r >= i[p - 1].tag, "Features must be added in alphabetical order."), o = {
                tag: r,
                feature: {
                  params: 0,
                  lookupListIndexes: []
                }
              }, i.push(o), s.push(p), o.feature
            }
          }
        },
        ...
        expandCoverage: function(e) {
          ...
          for (var t = [], r = e.ranges, n = 0; n < r.length; n++)
            for (var a = r[n], o = a.start, s = a.end, i = o; i <= s; i++) t.push(i);
          return t
        }
      }, tv.prototype = td.prototype, tv.prototype.init = function() {
        var e = this.getDefaultScriptName();
        this.defaultKerningTables = this.getKerningTables(e)
      }, tv.prototype.getKerningValue = function(e, t, r) {
        ...
        return 0
      }, tv.prototype.getKerningTables = function(e, t) {
        if (this.font.tables.gpos) return this.getLookupTables(e, t, "kern", 2)
      }, tg.prototype = td.prototype, tg.prototype.createDefaultTable = function() {
        return {
          version: 1,
          scripts: [{
            tag: "DFLT",
      ...
      }, tg.prototype.getSingle = function(e, t, r) {
        ...
        return n
      }, tg.prototype.getMultiple = function(e, t, r) {
        ...
        return n
      }, tg.prototype.getAlternates = function(e, t, r) {
        for (var n = [], a = this.getLookupTables(t, r, e, 3), o = 0; o < a.length; o++)
          for (var s = a[o].subtables, i = 0; i < s.length; i++)
            for (var u = s[i], p = this.expandCoverage(u.coverage), l = u.alternateSets, c = 0; c < p.length; c++) n.push({
              sub: p[c],
              by: l[c]
            });
        return n
      }, tg.prototype.getLigatures = function(e, t, r) {
          ...
          for (var s = a[o].subtables, i = 0; i < s.length; i++)
            for (var u = s[i], p = this.expandCoverage(u.coverage), l = u.ligatureSets, c = 0; c < p.length; c++)
              for (var h = p[c], f = l[c], d = 0; d < f.length; d++) {
                var v = f[d];
                n.push({
                  sub: [h].concat(v.components),
                  by: v.ligGlyph
                })
              }
        return n
      }, tg.prototype.addSingle = function(e, t, r, n) {
        var a = tm(this.getLookupTables(r, n, e, 1, !0)[0], 2, {
          substFormat: 2,
          coverage: {
            format: 1,
            glyphs: []
        ...
        M(1 === a.coverage.format, "Single: unable to modify coverage table format " + a.coverage.format);
        var o = t.sub,
      ...
      }, tg.prototype.addMultiple = function(e, t, r, n) {
        M(t.by instanceof Array && t.by.length > 1, 'Multiple: "by" must be an array of two or more ids');
        var a = tm(this.getLookupTables(r, n, e, 2, !0)[0], 1, {
          substFormat: 1,
          coverage: {
            format: 1,
            glyphs: []
        ...
        M(1 === a.coverage.format, "Multiple: unable to modify coverage table format " + a.coverage.format);
        var o = t.sub,
          s = this.binSearch(a.coverage.glyphs, o);
        s < 0 && (s = -1 - s, a.coverage.glyphs.splice(s, 0, o), a.sequences.splice(s, 0, 0)), a.sequences[s] = t.by
      }, tg.prototype.addAlternate = function(e, t, r, n) {
        var a = tm(this.getLookupTables(r, n, e, 3, !0)[0], 1, {
          substFormat: 1,
          coverage: {
            format: 1,
            glyphs: []
        ...
        M(1 === a.coverage.format, "Alternate: unable to modify coverage table format " + a.coverage.format);
        var o = t.sub,
          s = this.binSearch(a.coverage.glyphs, o);
        s < 0 && (s = -1 - s, a.coverage.glyphs.splice(s, 0, o), a.alternateSets.splice(s, 0, 0)), a.alternateSets[s] = t.by
      }, tg.prototype.addLigature = function(e, t, r, n) {
        ...
        o || (o = {
          ...
          ligatureSets: []
        }, a.subtables[0] = o), M(1 === o.coverage.format, "Ligature: unable to modify coverage table format " + o.coverage.format);
        var s = t.sub[0],
          i = t.sub.slice(1),
          u = {
            ligGlyph: t.by,
      ...
      }, tg.prototype.add = function(e, t, r, n) {
      ...
      function tx(e, t, r) {
        ...
        if (e.numberOfContours = n.parseShort(), e._xMin = n.parseShort(), e._yMin = n.parseShort(), e._xMax = n.parseShort(), e._yMax = n.parseShort(), e.numberOfContours > 0) {
          ...
          c = [];
          for (var u = 0; u < i; u += 1)
            if (h = n.parseByte(), c.push(h), (8 & h) > 0)
              for (var p = n.parseByte(), l = 0; l < p; l += 1) c.push(h), u += 1;
          if (M(c.length === i, "Bad flags."), a.length > 0) {
            var c, h, f, d = [];
            if (i > 0) {
              for (var v = 0; v < i; v += 1) h = c[v], (f = {}).onCurve = !!(1 & h), f.lastPointOfContour = a.indexOf(v) >= 0, d.push(f);
              for (var g = 0, m = 0; m < i; m += 1) h = c[m], (f = d[m]).x = tb(n, h, g, 2, 16), g = f.x;
              for (var y = 0, b = 0; b < i; b += 1) h = c[b], (f = d[b]).y = tb(n, h, y, 4, 32), y = f.y
            }
            e.points = d
          } else e.points = []
          ...
          for (var x = !0; x;) {
            ...
            (1 & c) > 0 ? (2 & c) > 0 ? (S.dx = n.parseShort(), S.dy = n.parseShort()) : S.matchedPoints = [n.parseUShort(), n.parseUShort()] : (2 & c) > 0 ? (S.dx = n.parseChar(), S.dy = n.parseChar()) : S.matchedPoints = [n.parseByte(), n.parseByte()], (8 & c) > 0 ? S.xScale = S.yScale = n.parseF2Dot14() : (64 & c) > 0 ? (S.xScale = n.parseF2Dot14(), S.yScale = n.parseF2Dot14()) : (128 & c) > 0 && (S.xScale = n.parseF2Dot14(), S.scale01 = n.parseF2Dot14(), S.scale10 = n.parseF2Dot14(), S.yScale = n.parseF2Dot14()), e.components.push(S), x = !!(32 & c)
          }
          if (256 & c) {
            e.instructionLength = n.parseUShort(), e.instructions = [];
            for (var k = 0; k < e.instructionLength; k += 1) e.instructions.push(n.parseByte())
          }
        }
      }
      ...
      function tk(e) {
        ...
        for (var r = function(e) {
            ...
            return M(0 === r.length, "There are still points left in the current contour."), t
          }(e), n = 0; n < r.length; ++n) {
          var a = r[n],
            o = null,
            s = a[a.length - 1],
          ...
          for (var p = 0; p < a.length; ++p)
            if (o = s, s = i, i = a[(p + 1) % a.length], s.onCurve) t.lineTo(s.x, s.y);
              ...
              var l = i;
              o.onCurve || (s.x, o.x, s.y, o.y), i.onCurve || (l = {
                x: (s.x + i.x) * .5,
                y: (s.y + i.y) * .5
        ...
        if (t.isComposite)
          for (var r = 0; r < t.components.length; r += 1) {
            ...
            if (a.getPath(), a.points) {
              var o = void 0;
              if (void 0 === n.matchedPoints) o = tS(a.points, n);
              else {
                ...
                i = tS([i], u)[0], u.dx = s.x - i.x, u.dy = s.y - i.y, o = tS(a.points, u)
              }
      ...
      var tU = function(e, t, r, n, a) {
        if (a.lowMemory) {
          var o;
          return o = new ex(n), n._push = function(a) {
            var s = r[a];
            s !== r[a + 1] ? o.push(a, ek(n, a, tx, e, t + s, tT)) : o.push(a, eS(n, a))
          }, o
        }
        for (var s = new ex(n), i = 0; i < r.length - 1; i += 1) {
          var u = r[i];
          u !== r[i + 1] ? s.push(i, ek(n, i, tx, e, t + u, tT)) : s.push(i, eS(n, i))
        }
        return s
      };
        ...
        tM = {
          ...
          interpolate: function(e, t, r, n) {
            ...
            if (!n || n === this) {
              ...
              e.x = e.xo + (u * i + p * s) / l;
              return
            }(a = n.distance(e, t, !0, !0), o = n.distance(e, r, !0, !0), u = n.distance(t, t, !1, !0), p = n.distance(r, r, !1, !0), 0 === (l = (s = Math.abs(a)) + (i = Math.abs(o)))) ? tM.setRelative(e, e, (u + p) / 2, n, !0): tM.setRelative(e, e, (u * i + p * s) / l, n, !0)
          },
          normalSlope: -1 / 0,
        ...
        tG = {
          ...
          interpolate: function(e, t, r, n) {
            ...
            if (!n || n === this) {
              ...
              e.y = e.yo + (u * i + p * s) / l;
              return
            }(a = n.distance(e, t, !0, !0), o = n.distance(e, r, !0, !0), u = n.distance(t, t, !1, !0), p = n.distance(r, r, !1, !0), 0 === (l = (s = Math.abs(a)) + (i = Math.abs(o)))) ? tG.setRelative(e, e, (u + p) / 2, n, !0): tG.setRelative(e, e, (u * i + p * s) / l, n, !0)
          },
          normalSlope: 0,
          setRelative: function(e, t, r, n, a) {
            if (!n || n === this) {
            ...
            var o = a ? t.xo : t.x,
              s = a ? t.yo : t.y,
              i = o + r * n.x;
            e.y = s + r * n.y + n.normalSlope * (e.x - i)
          },
          slope: 1 / 0,
          touch: function(e) {
            e.yTouched = !0
      ...
      function tA(e, t) {
        ...
        return (e /= r, t /= r, 1 === e && 0 === t) ? tM : 0 === e && 1 === t ? tG : new tB(e, t)
      }
      ...
      Object.freeze(tM), Object.freeze(tG), tB.prototype.distance = function(e, t, r, n) {
        return this.x * tM.distance(e, t, r, n) + this.y * tG.distance(e, t, r, n)
      }, tB.prototype.interpolate = function(e, t, r, n) {
        var a, o, s, i, u, p, l;
        (s = n.distance(e, t, !0, !0), i = n.distance(e, r, !0, !0), a = n.distance(t, t, !1, !0), o = n.distance(r, r, !1, !0), 0 === (l = (u = Math.abs(s)) + (p = Math.abs(i)))) ? this.setRelative(e, e, (a + o) / 2, n, !0): this.setRelative(e, e, (a * p + o * u) / l, n, !0)
      }, tB.prototype.setRelative = function(e, t, r, n, a) {
        n = n || this;
        var o = a ? t.xo : t.x,
          s = a ? t.yo : t.y,
          i = o + r * n.x,
      ...
      function tH(e, t) {
        switch (this.env = e, this.stack = [], this.prog = t, e) {
          ...
          case "prep":
            this.fv = this.pv = this.dpv = tM, this.round = tR
        }
      }

      function tz(e) {
        for (var t = e.tZone = Array(e.gZone.length), r = 0; r < t.length; r++) t[r] = new tF(0, 0)
      }
      ...
      function tV(e, t) {
        var r, n, a = t.stack,
          ...
          i = t.z2[o],
          u = t.z1[s];
        exports.DEBUG && console.log("SPVTL[" + e + "]", o, s), e ? (r = i.y - u.y, n = u.x - i.x) : (r = u.x - i.x, n = u.y - i.y), t.pv = t.dpv = tA(r, n)
      }
      ...
      function tY(e, t) {
        var r, n, a = t.stack,
          ...
          i = t.z2[o],
          u = t.z1[s];
        exports.DEBUG && console.log("SFVTL[" + e + "]", o, s), e ? (r = i.y - u.y, n = u.x - i.x) : (r = u.x - i.x, n = u.y - i.y), t.fv = tA(r, n)
      }
      ...
      function tZ(e, t) {
        ...
        var s = o.distance(n, tN);
        e && (s = t.round(s)), a.setRelative(n, tN, s, o), a.touch(n), t.rp0 = t.rp1 = r
      }
      ...
      function tJ(e, t) {
        ...
        do p !== a && o.setRelative(p, p, l, s), p = p.nextPointOnContour; while (p !== u)
      }
      ...
      function t1(e, t) {
        ...
        var p = i.distance(o, tN);
        e && (Math.abs(p - u) < t.cvCutIn && (p = u), p = t.round(p)), s.setRelative(o, tN, p, i), 0 === t.zp0 && (o.xo = o.x, o.yo = o.y), s.touch(o), t.rp0 = t.rp1 = a
      }
      ...
      function t2(e, t) {
        var r = t.stack,
          n = r.pop(),
          a = t.z2[n];
        exports.DEBUG && console.log(t.step, "GC[" + e + "]", n), r.push(64 * t.dpv.distance(a, tN, e, !1))
      }
      ...
      function t8(e, t) {
        var r, n, a = t.stack,
          ...
          i = t.z2[o],
          u = t.z1[s];
        exports.DEBUG && console.log(t.step, "SDPVTL[" + e + "]", o, s), e ? (r = i.y - u.y, n = u.x - i.x) : (r = u.x - i.x, n = u.y - i.y), t.dpv = tA(r, n)
      }
      ...
      function re(e, t, r, n, a, o) {
        var s, i, u, p, l = o.stack,
          c = e && l.pop(),
          h = l.pop(),
          f = o.rp0,
          d = o.z0[f],
          ...
          m = o.fv,
          y = o.dpv;
        u = (i = s = y.distance(v, d, !0, !0)) >= 0 ? 1 : -1, i = Math.abs(i), e && (p = o.cvt[c], n && Math.abs(i - p) < o.cvCutIn && (i = p)), r && i < g && (i = g), n && (i = o.round(i)), m.setRelative(v, d, u * i, y), m.touch(v), exports.DEBUG && console.log(o.step, (e ? "MIRP[" : "MDRP[") + (t ? "M" : "m") + (r ? ">" : "_") + (n ? "R" : "_") + (0 === a ? "Gr" : 1 === a ? "Bl" : 2 === a ? "Wh" : "") + "]", e ? c + "(" + o.cvt[c] + "," + p + ")" : "", h, "(d =", s, "->", u * i, ")"), o.rp1 = o.rp0, o.rp2 = h, t && (o.rp0 = h)
      }
      ...
      function rv(e, t) {
        return -1 === rd(e, t.coverage) ? null : e + t.deltaGlyphId
      }

      function rg(e, t) {
        var r = rd(e, t.coverage);
      ...
      function rm(e, t) {
        for (var r = [], n = 0; n < e.length; n++) {
          var a = e[n],
            o = t.current,
            s = rd(o = Array.isArray(o) ? o[0] : o, a); - 1 !== s && r.push(s)
        }
      ...
      function ry(e, t) {
        ...
        var n = rm(t.inputCoverage, e);
        if (-1 === n) return [];
        var a = t.inputCoverage.length - 1;
        if (e.lookahead.length < t.lookaheadCoverage.length) return [];
        for (var o = e.lookahead.slice(a); o.length && rl(o[0].char);) o.shift();
        var s = new ra(o, 0),
          i = rm(t.lookaheadCoverage, s),
          u = [].concat(e.backtrack);
        for (u.reverse(); u.length && rl(u[0].char);) u.shift();
        if (u.length < t.backtrackCoverage.length) return [];
        var p = new ra(u, 0),
          l = rm(t.backtrackCoverage, p),
        ...
        if (c)
          for (var f = 0; f < t.lookupRecords.length; f++)
            for (var d = t.lookupRecords[f].lookupListIndex, v = this.getLookupByIndex(d), g = 0; g < v.subtables.length; g++) {
              var m = v.subtables[g],
                y = this.getLookupMethod(v, m);
              if ("12" === this.getSubstitutionType(v, m))
      ...
      function rb(e, t) {
        var r, n = rd(e.current, t.coverage);
        if (-1 === n) return null;
      ...
      tO.prototype.exec = function(e, t) {
        ...
        if (!(this._errorState > 2)) {
          ...
          if (!n || n.ppem !== t) {
            ...
            if (!a) {
              tH.prototype = tP, (a = this._fpgmState = new tH("fpgm", r.tables.fpgm)).funcs = [], a.font = r, exports.DEBUG && (console.log("---EXEC FPGM---"), a.step = -1);
              try {
                u(a)
              } catch (e) {
            ...
            tH.prototype = a, (n = this._prepState = new tH("prep", r.tables.prep)).ppem = t;
            var o = r.tables.cvt;
            if (o)
              for (var s = n.cvt = Array(o.length), i = t / r.unitsPerEm, l = 0; l < o.length; l++) s[l] = o[l] * i;
            else n.cvt = [];
        ...
        var r, n, a, o = t.ppem / t.font.unitsPerEm,
          s = e.components;
        if (tH.prototype = t, s) {
          var i = t.font;
          n = [], r = [];
          for (var p = 0; p < s.length; p++) {
            var c = s[p],
              h = i.glyphs.get(c.glyphIndex);
            a = new tH("glyf", h.instructions), exports.DEBUG && (console.log("---EXEC COMP " + p + "---"), a.step = -1), l(h, a, o, o);
            for (var f = Math.round(c.dx * o), d = Math.round(c.dy * o), v = a.gZone, g = a.contours, m = 0; m < v.length; m++) {
              var y = v[m];
          ...
          e.instructions && !a.inhibitGridFit && ((a = new tH("glyf", e.instructions)).gZone = a.z0 = a.z1 = a.z2 = n, a.contours = r, n.push(new tF(0, 0), new tF(Math.round(e.advanceWidth * o), 0)), exports.DEBUG && (console.log("---EXEC COMPOSITE---"), a.step = -1), u(a), n.length -= 2)
        } else a = new tH("glyf", e.instructions), exports.DEBUG && (console.log("---EXEC GLYPH---"), a.step = -1), l(e, a, o, o), n = a.gZone;
        return n
      }, l = function(e, t, r, n) {
        for (var a, o, s, i = e.points || [], p = i.length, l = t.gZone = t.z0 = t.z1 = t.z2 = [], c = t.contours = [], h = 0; h < p; h++) a = i[h], l[h] = new tF(a.x * r, a.y * n, a.lastPointOfContour, a.onCurve);
        for (var f = 0; f < p; f++) a = l[f], o || (o = a, c.push(f)), a.lastPointOfContour ? (a.nextPointOnContour = o, o.prevPointOnContour = a, o = void 0) : (s = l[f + 1], a.nextPointOnContour = s, s.prevPointOnContour = a);
        if (!t.inhibitGridFit) {
          if (exports.DEBUG) {
            console.log("PROCESSING GLYPH", t.stack);
            for (var d = 0; d < p; d++) console.log(d, l[d].x, l[d].y)
          }
          if (l.push(new tF(0, 0), new tF(Math.round(e.advanceWidth * r), 0)), u(t), l.length -= 2, exports.DEBUG) {
            console.log("FINISHED GLYPH", t.stack);
            for (var v = 0; v < p; v++) console.log(v, l[v].x, l[v].y)
          }
        }
      }, u = function(e) {
        var t, r = e.prog;
        if (r) {
          ...
          for (e.ip = 0; e.ip < n; e.ip++) {
            if (exports.DEBUG && e.step++, !(t = i[r[e.ip]])) throw Error("unknown instruction: 0x" + Number(r[e.ip]).toString(16));
            t(e)
          }
        }
      }, i = [tq.bind(void 0, tG), tq.bind(void 0, tM), t_.bind(void 0, tG), t_.bind(void 0, tM), tX.bind(void 0, tG), tX.bind(void 0, tM), tV.bind(void 0, 0), tV.bind(void 0, 1), tY.bind(void 0, 0), tY.bind(void 0, 1), function(e) {
        var t = e.stack,
          r = t.pop(),
          n = t.pop();
        exports.DEBUG && console.log(e.step, "SPVFS[]", r, n), e.pv = e.dpv = tA(n, r)
      }, function(e) {
        var t = e.stack,
          r = t.pop(),
          n = t.pop();
        exports.DEBUG && console.log(e.step, "SPVFS[]", r, n), e.fv = tA(n, r)
      }, function(e) {
        var t = e.stack,
          r = e.pv;
        ...
        var d = p.x,
          ...
          T = d * m - v * g,
          U = y * S - b * x;
        f.x = (T * (y - x) - U * (d - g)) / k, f.y = (T * (b - S) - U * (v - m)) / k
      }, function(e) {
        ...
        switch (exports.DEBUG && console.log(e.step, "SZPS[]", t), e.zp0 = e.zp1 = e.zp2 = t, t) {
          case 0:
            e.tZone || tz(e), e.z0 = e.z1 = e.z2 = e.tZone;
            break;
          case 1:
        ...
        exports.DEBUG && console.log(e.step, "RTG[]"), e.round = tR
      }, function(e) {
        exports.DEBUG && console.log(e.step, "RTHG[]"), e.round = tL
      }, function(e) {
        var t = e.stack.pop();
        exports.DEBUG && console.log(e.step, "SMD[]", t), e.minDis = t / 64
      }, function(e) {
        exports.DEBUG && console.log(e.step, "ELSE[]"), tW(e, !1)
      }, function(e) {
        var t = e.stack.pop();
        ...
        var a = e.ip,
          o = e.prog;
        e.prog = e.funcs[r];
        for (var s = 0; s < n; s++) u(e), exports.DEBUG && console.log(++e.step, s + 1 < n ? "next loopcall" : "done loopcall", s);
        e.ip = a, e.prog = o
      }, function(e) {
        var t = e.stack.pop();
        ...
        var r = e.ip,
          n = e.prog;
        e.prog = e.funcs[t], u(e), e.ip = r, e.prog = n, exports.DEBUG && console.log(++e.step, "returning from", t)
      }, function(e) {
      ...
      }, void 0, tZ.bind(void 0, 0), tZ.bind(void 0, 1), tQ.bind(void 0, tG), tQ.bind(void 0, tM), tK.bind(void 0, 0), tK.bind(void 0, 1), tJ.bind(void 0, 0), tJ.bind(void 0, 1), t$.bind(void 0, 0), t$.bind(void 0, 1), function(e) {
        ...
        e.loop = 1
      }, t0.bind(void 0, 0), t0.bind(void 0, 1), function(e) {
        ...
        exports.DEBUG && console.log(e.step, "RTDG[]"), e.round = tC
      }, t1.bind(void 0, 0), t1.bind(void 0, 1), function(e) {
        var t = e.prog,
          r = e.ip,
          n = e.stack,
          a = t[++r];
      ...
      }, t2.bind(void 0, 0), t2.bind(void 0, 1), void 0, t6.bind(void 0, 0), t6.bind(void 0, 1), function(e) {
        ...
        var t = e.stack.pop();
        exports.DEBUG && console.log(e.step, "IF[]", t), !t && (tW(e, !0), exports.DEBUG && console.log(e.step, "EIF[]"))
      }, function(e) {
      ...
      }, t5.bind(void 0, 0), t5.bind(void 0, 1), t5.bind(void 0, 2), t5.bind(void 0, 3), void 0, void 0, void 0, void 0, function(e) {
        var t = e.stack,
          r = t.pop(),
          n = t.pop();
        exports.DEBUG && console.log(e.step, "WCVTF[]", r, n), e.cvt[n] = r * e.ppem / e.font.unitsPerEm
      }, t3.bind(void 0, 2), t3.bind(void 0, 3), t4.bind(void 0, 1), t4.bind(void 0, 2), t4.bind(void 0, 3), function(e) {
        var t, r = e.stack.pop();
        switch (exports.DEBUG && console.log(e.step, "SROUND[]", r), e.round = tI, 192 & r) {
          case 0:
            t = .5;
            break;
          case 64:
        ...
        var t, r = e.stack.pop();
        switch (exports.DEBUG && console.log(e.step, "S45ROUND[]", r), e.round = tI, 192 & r) {
          case 0:
            t = Math.sqrt(2) / 2;
            break;
          case 64:
        ...
        exports.DEBUG && console.log(e.step, "ROFF[]"), e.round = tE
      }, void 0, function(e) {
        exports.DEBUG && console.log(e.step, "RUTG[]"), e.round = tD
      }, function(e) {
        exports.DEBUG && console.log(e.step, "RDTG[]"), e.round = tw
      }, tj, tj, void 0, void 0, void 0, void 0, void 0, function(e) {
        var t = e.stack.pop();
        exports.DEBUG && console.log(e.step, "SCANCTRL[]", t)
      }, t8.bind(void 0, 0), t8.bind(void 0, 1), function(e) {
        var t = e.stack,
          r = t.pop(),
          n = 0;
      ...
      }, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, void 0, t7.bind(void 0, 1), t7.bind(void 0, 2), t7.bind(void 0, 3), t7.bind(void 0, 4), t7.bind(void 0, 5), t7.bind(void 0, 6), t7.bind(void 0, 7), t7.bind(void 0, 8), t9.bind(void 0, 1), t9.bind(void 0, 2), t9.bind(void 0, 3), t9.bind(void 0, 4), t9.bind(void 0, 5), t9.bind(void 0, 6), t9.bind(void 0, 7), t9.bind(void 0, 8), re.bind(void 0, 0, 0, 0, 0, 0), re.bind(void 0, 0, 0, 0, 0, 1), re.bind(void 0, 0, 0, 0, 0, 2), re.bind(void 0, 0, 0, 0, 0, 3), re.bind(void 0, 0, 0, 0, 1, 0), re.bind(void 0, 0, 0, 0, 1, 1), re.bind(void 0, 0, 0, 0, 1, 2), re.bind(void 0, 0, 0, 0, 1, 3), re.bind(void 0, 0, 0, 1, 0, 0), re.bind(void 0, 0, 0, 1, 0, 1), re.bind(void 0, 0, 0, 1, 0, 2), re.bind(void 0, 0, 0, 1, 0, 3), re.bind(void 0, 0, 0, 1, 1, 0), re.bind(void 0, 0, 0, 1, 1, 1), re.bind(void 0, 0, 0, 1, 1, 2), re.bind(void 0, 0, 0, 1, 1, 3), re.bind(void 0, 0, 1, 0, 0, 0), re.bind(void 0, 0, 1, 0, 0, 1), re.bind(void 0, 0, 1, 0, 0, 2), re.bind(void 0, 0, 1, 0, 0, 3), re.bind(void 0, 0, 1, 0, 1, 0), re.bind(void 0, 0, 1, 0, 1, 1), re.bind(void 0, 0, 1, 0, 1, 2), re.bind(void 0, 0, 1, 0, 1, 3), re.bind(void 0, 0, 1, 1, 0, 0), re.bind(void 0, 0, 1, 1, 0, 1), re.bind(void 0, 0, 1, 1, 0, 2), re.bind(void 0, 0, 1, 1, 0, 3), re.bind(void 0, 0, 1, 1, 1, 0), re.bind(void 0, 0, 1, 1, 1, 1), re.bind(void 0, 0, 1, 1, 1, 2), re.bind(void 0, 0, 1, 1, 1, 3), re.bind(void 0, 1, 0, 0, 0, 0), re.bind(void 0, 1, 0, 0, 0, 1), re.bind(void 0, 1, 0, 0, 0, 2), re.bind(void 0, 1, 0, 0, 0, 3), re.bind(void 0, 1, 0, 0, 1, 0), re.bind(void 0, 1, 0, 0, 1, 1), re.bind(void 0, 1, 0, 0, 1, 2), re.bind(void 0, 1, 0, 0, 1, 3), re.bind(void 0, 1, 0, 1, 0, 0), re.bind(void 0, 1, 0, 1, 0, 1), re.bind(void 0, 1, 0, 1, 0, 2), re.bind(void 0, 1, 0, 1, 0, 3), re.bind(void 0, 1, 0, 1, 1, 0), re.bind(void 0, 1, 0, 1, 1, 1), re.bind(void 0, 1, 0, 1, 1, 2), re.bind(void 0, 1, 0, 1, 1, 3), re.bind(void 0, 1, 1, 0, 0, 0), re.bind(void 0, 1, 1, 0, 0, 1), re.bind(void 0, 1, 1, 0, 0, 2), re.bind(void 0, 1, 1, 0, 0, 3), re.bind(void 0, 1, 1, 0, 1, 0), re.bind(void 0, 1, 1, 0, 1, 1), re.bind(void 0, 1, 1, 0, 1, 2), re.bind(void 0, 1, 1, 0, 1, 3), re.bind(void 0, 1, 1, 1, 0, 0), re.bind(void 0, 1, 1, 1, 0, 1), re.bind(void 0, 1, 1, 1, 0, 2), re.bind(void 0, 1, 1, 1, 0, 3), re.bind(void 0, 1, 1, 1, 1, 0), re.bind(void 0, 1, 1, 1, 1, 1), re.bind(void 0, 1, 1, 1, 1, 2), re.bind(void 0, 1, 1, 1, 1, 3)], rt.prototype.setState = function(e, t) {
        return this.state[e] = t, this.activeState = {
          key: e,
          value: this.state[e]
        }, this.activeState
      }, rt.prototype.getState = function(e) {
        return this.state[e] || null
      }, ri.prototype.inboundIndex = function(e) {
        return e >= 0 && e < this.tokens.length
      }, ri.prototype.composeRUD = function(e) {
        var t = this,
          r = e.map(function(e) {
      ...
      }, ri.prototype.replaceRange = function(e, t, r, n) {
        t = null !== t ? t : this.tokens.length;
        var a = r.every(function(e) {
          return e instanceof rt
        });
        if (!(!isNaN(e) && this.inboundIndex(e)) || !a) return {
      ...
      }, ro.prototype.subscribe = function(e) {
        return "function" == typeof e ? this.subscribers.push(e) - 1 : {
          FAIL: "invalid '" + this.eventId + "' event handler"
        }
      }, ro.prototype.unsubscribe = function(e) {
        this.subscribers.splice(e, 1)
      }, ra.prototype.setCurrentIndex = function(e) {
      ...
      }, ri.prototype.rangeToText = function(e) {
        if (e instanceof rr) return this.getRangeTokens(e).map(function(e) {
          return e.char
        }).join("")
      ...
      }, ri.prototype.getContext = function(e) {
        return this.registeredContexts[e] || null
      }, ri.prototype.on = function(e, t) {
        var r = this.events[e];
        return r ? r.subscribe(t) : null
      }, ri.prototype.dispatch = function(e, t) {
        var r = this,
          n = this.events[e];
        n instanceof ro && n.subscribers.forEach(function(e) {
          e.apply(r, t || [])
        })
      }, ri.prototype.registerContextChecker = function(e, t, r) {
      ...
      }, ri.prototype.setEndOffset = function(e, t) {
        var r = new rr(this.getContext(t).openRange.startIndex, e, t),
          n = this.getContext(t).ranges;
        return r.rangeId = t + "." + n.length, n.push(r), this.getContext(t).openRange = null, r
      }, ri.prototype.runContextCheck = function(e) {
        var t = this,
          r = e.index;
        this.contextCheckers.forEach(function(n) {
          var a = n.contextName,
            o = t.getContext(a).openRange;
          if (!o && n.checkStart(e) && (o = new rr(r, null, a), t.getContext(a).openRange = o, t.dispatch("contextStart", [a, r])), o && n.checkEnd(e)) {
            var s = r - o.startIndex + 1,
              i = t.setEndOffset(s, a);
            t.dispatch("contextEnd", [a, i])
          }
        })
      }, ri.prototype.tokenize = function(e) {
      ...
      }, rh.prototype.mapTagsToFeatures = function(e, t) {
        for (var r = {}, n = 0; n < e.length; n++) {
          var a = e[n].tag,
            o = e[n].feature;
          r[a] = o
      ...
      }, rh.prototype.getScriptFeatures = function(e) {
      ...
      }, rh.prototype.getSubstitutionType = function(e, t) {
        return e.lookupType.toString() + t.substFormat.toString()
      }, rh.prototype.getLookupMethod = function(e, t) {
        var r = this;
        switch (this.getSubstitutionType(e, t)) {
          case "11":
            return function(e) {
              return rv.apply(r, [e, t])
            };
          case "12":
            return function(e) {
              return rg.apply(r, [e, t])
            };
          case "63":
            return function(e) {
              return ry.apply(r, [e, t])
            };
          case "41":
            return function(e) {
              return rb.apply(r, [e, t])
            };
          case "21":
            return function(e) {
              return rx.apply(r, [e, t])
            };
          default:
            throw Error("lookupType: " + e.lookupType + " - substFormat: " + t.substFormat + " is not yet supported")
        }
      }, rh.prototype.lookupFeature = function(e) {
        ...
        for (var a = this.getFeatureLookups(n), o = [].concat(t.context), s = 0; s < a.length; s++)
          for (var i = a[s], u = this.getLookupSubtables(i), p = 0; p < u.length; p++) {
            ...
            switch (c) {
              case "11":
                (f = h(t.current)) && o.splice(r, 1, new rf({
                  id: 11,
                  tag: e.tag,
                  substitution: f
                }));
              ...
              case "12":
                ...
                break;
              case "63":
                Array.isArray(f = h(t)) && f.length && o.splice(r, 1, new rf({
                  id: 63,
                  tag: e.tag,
                  substitution: f
                }));
            ...
            t = new ra(o, r), (!Array.isArray(f) || f.length) && (f = null)
          }
        return o.length ? o : null
      }, rh.prototype.supports = function(e) {
        ...
        return t && r
      }, rh.prototype.getLookupSubtables = function(e) {
        return e.subtables || null
      }, rh.prototype.getLookupByIndex = function(e) {
        return this.font.tables.gsub.lookups[e] || null
      }, rh.prototype.getFeatureLookups = function(e) {
        return e.lookupListIndexes.map(this.getLookupByIndex.bind(this))
      }, rh.prototype.getFeature = function(e) {
        if (!this.font) return {
      ...
      function rk(e, t, r) {
        e instanceof rf && rS[e.id] && rS[e.id](e, t, r)
      }
      ...
      function rT(e) {
        ...
        if (1 !== a.length) {
          var o = new ra(a.map(function(e) {
              return e.getState("glyphIndex")
            }), 0),
            s = new ra(a.map(function(e) {
              return e.char
            }), 0);
          a.forEach(function(e, i) {
            if (!rl(e.char)) {
              ...
              switch (function(e) {
                  ...
                  if (rp(e.current)) return !1;
                  for (var t = 0; t < e.lookahead.length; t++)
                    if (!rl(e.lookahead[t])) return !0;
                  return !1
                }(s) && (p |= 2), p) {
                case 1:
                  u = "fina";
              ...
              if (-1 !== n.indexOf(u)) {
                ...
                l.forEach(function(e, t) {
                  e instanceof rf && (rk(e, a, t), o.context[t] = e.substitution)
                })
              }
            }
          })
      ...
      function rU(e, t) {
        return new ra(e.map(function(e) {
      ...
      function rC(e) {
        this.baseDir = e || "ltr", this.tokenizer = new ri, this.featuresTags = {}
      }
      ...
      function rD() {
        return rL.call(this, "latinWord"), rL.call(this, "arabicWord"), rL.call(this, "arabicSentence"), this.tokenizer.tokenize(this.text)
      }
      ...
      function rM() {
        var e = this;
        this.featuresTags.hasOwnProperty("arab") && (rI.call(this), this.tokenizer.getContextRanges("arabicWord").forEach(function(t) {
          rT.call(e, t)
        }))
      }
      ...
      function rG() {
        var e = this,
          t = "arab";
        this.featuresTags.hasOwnProperty(t) && -1 !== this.featuresTags[t].indexOf("rlig") && (rI.call(this), this.tokenizer.getContextRanges("arabicWord").forEach(function(t) {
          rO.call(e, t)
        }))
      }
      ...
      function rB() {
        var e = this,
          t = "latn";
        this.featuresTags.hasOwnProperty(t) && -1 !== this.featuresTags[t].indexOf("liga") && (rI.call(this), this.tokenizer.getContextRanges("latinWord").forEach(function(t) {
          rR.call(e, t)
        }))
      }

      function rA(e) {
        (e = e || {}).tables = e.tables || {}, e.empty || (ty(e.familyName, "When creating a new Font object, familyName is required."), ty(e.styleName, "When creating a new Font object, styleName is required."), ty(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."), ty(e.ascender, "When creating a new Font object, ascender is required."), ty(e.descender <= 0, "When creating a new Font object, negative descender value is required."), this.names = {
          fontFamily: {
            en: e.familyName || " "
          },
          fontSubfamily: {
        ...
        })), this.supported = !0, this.glyphs = new ex(this, e.glyphs || []), this.encoding = new ef(this), this.position = new tv(this), this.substitution = new tg(this), this.tables = this.tables || {}, this._push = null, this._hmtxTableData = {}, Object.defineProperty(this, "hinting", {
          get: function() {
            return this._hinting ? this._hinting : "truetype" === this.outlinesFormat ? this._hinting = new tO(this) : void 0
          }
        })
      }
      rC.prototype.setText = function(e) {
        this.text = e
      }, rC.prototype.contextChecks = {
        latinWordCheck: {
          startCheck: function(e) {
            var t = e.current,
              r = e.get(-1);
            return null === r && rc(t) || !rc(r) && rc(t)
          },
          endCheck: function(e) {
            var t = e.get(1);
            return null === t || !rc(t)
          ...
          endCheck: function(e) {
            ...
            switch (!0) {
              ...
              case !ru(t) && !rl(t):
                var r = /\s/.test(t);
                if (!r) return !0;
                if (r && !e.lookahead.some(function(e) {
                    return ru(e) || rl(e)
                  })) return !0;
                break;
              default:
      ...
      }, rC.prototype.registerFeatures = function(e, t) {
        var r = this,
      ...
      }, rC.prototype.applyFeatures = function(e, t) {
        if (!e) throw Error("No valid font was provided to apply features");
        this.query || (this.query = new rh(e));
        for (var r = 0; r < t.length; r++) {
          var n = t[r];
          this.query.supports({
            script: n.script
      ...
      }, rC.prototype.registerModifier = function(e, t, r) {
        this.tokenizer.registerModifier(e, t, r)
      }, rC.prototype.checkContextReady = function(e) {
        return !!this.tokenizer.getContext(e)
      }, rC.prototype.applyFeaturesToContexts = function() {
        this.checkContextReady("arabicWord") && (rM.call(this), rG.call(this)), this.checkContextReady("latinWord") && rB.call(this), this.checkContextReady("arabicSentence") && rw.call(this)
      }, rC.prototype.processText = function(e) {
        this.text && this.text === e || (this.setText(e), rD.call(this), this.applyFeaturesToContexts())
      }, rC.prototype.getBidiText = function(e) {
        return this.processText(e), this.tokenizer.getText()
      }, rC.prototype.getTextGlyphs = function(e) {
        this.processText(e);
        ...
        return t
      }, rA.prototype.hasChar = function(e) {
        return null !== this.encoding.charToGlyphIndex(e)
      }, rA.prototype.charToGlyphIndex = function(e) {
        return this.encoding.charToGlyphIndex(e)
      }, rA.prototype.charToGlyph = function(e) {
        var t = this.charToGlyphIndex(e),
          r = this.glyphs.get(t);
        return r || (r = this.glyphs.get(0)), r
      }, rA.prototype.updateFeatures = function(e) {
      ...
      }, rA.prototype.stringToGlyphs = function(e, t) {
        var r = this,
          n = new rC;
        ...
        return i
      }, rA.prototype.nameToGlyphIndex = function(e) {
        return this.glyphNames.nameToGlyphIndex(e)
      }, rA.prototype.nameToGlyph = function(e) {
        var t = this.nameToGlyphIndex(e),
          r = this.glyphs.get(t);
        return r || (r = this.glyphs.get(0)), r
      }, rA.prototype.glyphIndexToName = function(e) {
        return this.glyphNames.glyphIndexToName ? this.glyphNames.glyphIndexToName(e) : ""
      }, rA.prototype.getKerningValue = function(e, t) {
      ...
      }, rA.prototype.defaultRenderOptions = {
        kerning: !0,
        features: [{
          script: "arab",
        ...
        for (var l = 0; l < u.length; l += 1) {
          var c = u[l];
          o.call(this, c, t, r, n, a), c.advanceWidth && (t += c.advanceWidth * i), a.kerning && l < u.length - 1 && (t += (s ? this.position.getKerningValue(s, c.index, u[l + 1].index) : this.getKerningValue(c, u[l + 1])) * i), a.letterSpacing ? t += a.letterSpacing * n : a.tracking && (t += a.tracking / 1e3 * n)
        }
        return t
      }, rA.prototype.getPath = function(e, t, r, n, a) {
        var o = new I;
        return this.forEachGlyph(e, t, r, n, a, function(e, t, r, n) {
          var s = e.getPath(t, r, n, a, this);
          o.extend(s)
        }), o
      }, rA.prototype.getPaths = function(e, t, r, n, a) {
        var o = [];
        return this.forEachGlyph(e, t, r, n, a, function(e, t, r, n) {
          var s = e.getPath(t, r, n, a, this);
          o.push(s)
        }), o
      }, rA.prototype.getAdvanceWidth = function(e, t, r) {
        return this.forEachGlyph(e, 0, 0, t, r, function() {})
      }, rA.prototype.draw = function(e, t, r, n, a, o) {
        this.getPath(t, r, n, a, o).draw(e)
      }, rA.prototype.drawPoints = function(e, t, r, n, a, o) {
        this.forEachGlyph(t, r, n, a, o, function(t, r, n, a) {
          t.drawPoints(e, r, n, a)
        })
      }, rA.prototype.drawMetrics = function(e, t, r, n, a, o) {
        this.forEachGlyph(t, r, n, a, o, function(t, r, n, a) {
          t.drawMetrics(e, r, n, a)
        })
      }, rA.prototype.getEnglishName = function(e) {
        var t = this.names[e];
        if (t) return t.en
      ...
      }, rA.prototype.toTables = function() {
        return tl(this)
      }, rA.prototype.toBuffer = function() {
        return console.warn("Font.toBuffer is deprecated. Use Font.toArrayBuffer instead."), this.toArrayBuffer()
      }, rA.prototype.toArrayBuffer = function() {
        for (var e = this.toTables().encode(), t = new ArrayBuffer(e.length), r = new Uint8Array(t), n = 0; n < e.length; n++) r[n] = e[n];
        return t
      }, rA.prototype.download = function(e) {
        ...
        if ("undefined" != typeof window)
          ...
          var u = r(47256),
            p = function(e) {
              for (var t = new c(e.byteLength), r = new Uint8Array(e), n = 0; n < t.length; ++n) t[n] = r[n];
              return t
            }(a);
          u.writeFileSync(e, p)
        }
      }, rA.prototype.fsSelectionValues = {
        ITALIC: 1,
        UNDERSCORE: 2,
        NEGATIVE: 4,
        OUTLINED: 8,
      ...
      var rF = function(e, t, r) {
          var n = new et(e, t);
          M(65536 === n.parseULong(), "Unsupported fvar table version.");
          var a = n.parseOffset16();
          n.skip("uShort", 1);
          for (var o = n.parseUShort(), s = n.parseUShort(), i = n.parseUShort(), u = n.parseUShort(), p = [], l = 0; l < o; l++) p.push(function(e, t, r) {
            var n = {},
              a = new et(e, t);
          ...
          for (var c = [], h = t + a + o * s, f = 0; f < i; f++) c.push(function(e, t, r, n) {
            var a = {},
              o = new et(e, t);
        ...
        rN = function() {
          return {
            coverage: this.parsePointer(et.coverage),
            attachPoints: this.parseList(et.pointer(et.uShortList))
          }
        },
        rP = function() {
          var e = this.parseUShort();
          return (M(1 === e || 2 === e || 3 === e, "Unsupported CaretValue table version."), 1 === e) ? {
        ...
        rH = function() {
          return this.parseList(et.pointer(rP))
        },
        rz = function() {
          return {
            coverage: this.parsePointer(et.coverage),
            ligGlyphs: this.parseList(et.pointer(rH))
          }
        },
        rW = function() {
          return this.parseUShort(), this.parseList(et.pointer(et.coverage))
        },
        rq = function(e, t) {
          var r = new et(e, t = t || 0),
            n = r.parseVersion(1);
          M(1 === n || 1.2 === n || 1.3 === n, "Unsupported GDEF table version.");
          var a = {
            version: n,
            classDef: r.parsePointer(et.classDef),
            attachList: r.parsePointer(rN),
            ligCaretList: r.parsePointer(rz),
            markAttachClassDef: r.parsePointer(et.classDef)
          };
          return n >= 1.2 && (a.markGlyphSets = r.parsePointer(rW)), a
        },
        r_ = Array(10);
      r_[1] = function() {
        var e = this.offset + this.relativeOffset,
        ...
        } : void M(!1, "0x" + e.toString(16) + ": GPOS lookup type 1 format must be 1 or 2.")
      }, r_[2] = function() {
        var e = this.offset + this.relativeOffset,
          t = this.parseUShort();
        M(1 === t || 2 === t, "0x" + e.toString(16) + ": GPOS lookup type 2 format must be 1 or 2.");
        var r = this.parsePointer(et.coverage),
          n = this.parseUShort(),
          a = this.parseUShort();
        if (1 === t) return {
          posFormat: t,
          ...
          valueFormat1: n,
          valueFormat2: a,
          pairSets: this.parseList(et.pointer(et.list(function() {
            return {
        ...
        if (2 === t) {
          var o = this.parsePointer(et.classDef),
            s = this.parsePointer(et.classDef),
            i = this.parseUShort(),
            u = this.parseUShort();
          return {
            posFormat: t,
            ...
            class1Count: i,
            class2Count: u,
            classRecords: this.parseList(i, et.list(u, function() {
              return {
                value1: this.parseValueRecord(n),
                value2: this.parseValueRecord(a)
              }
      ...
      var rX = function(e, t) {
          var r = new et(e, t = t || 0),
            n = r.parseVersion(1);
          return (M(1 === n || 1.1 === n, "Unsupported GPOS table version " + n), 1 === n) ? {
            version: n,
            scripts: r.parseScriptList(),
            features: r.parseFeatureList(),
            lookups: r.parseLookupList(r_)
          } : {
            version: n,
            scripts: r.parseScriptList(),
            features: r.parseFeatureList(),
        ...
        rV = function(e, t) {
          ...
          if (0 === n) return function(e) {
            var t = {};
            e.skip("uShort"), M(0 === e.parseUShort(), "Unsupported kern sub-table version."), e.skip("uShort", 2);
            var r = e.parseUShort();
            e.skip("uShort", 3);
            for (var n = 0; n < r; n += 1) {
              var a = e.parseUShort(),
        ...
        rY = function(e, t, r, n) {
          for (var a = new et(e, t), o = n ? a.parseUShort : a.parseULong, s = [], i = 0; i < r + 1; i += 1) {
            var u = o.call(a);
            n && (u *= 2), s.push(u)
          }
          return s
      ...
      function rZ(e, t) {
        ...
        if (L(r, n), n.byteLength !== t.length) throw Error("Decompression error: " + t.tag + " decompressed length doesn't match recorded length");
        return {
      ...
      function rQ(e, t) {
        t = null == t ? {} : t;
        var r, n, a, o, s, i, u, p, l, c, h, f, d, v, g, m = new rA({
            empty: !0
          }),
          y = new DataView(e, 0),
          b = [],
          x = en(y, 0);
        if (x === String.fromCharCode(0, 1, 0, 0) || "true" === x || "typ1" === x) m.outlinesFormat = "truetype", a = J(y, 4), b = rj(y, a);
        else if ("OTTO" === x) m.outlinesFormat = "cff", a = J(y, 4), b = rj(y, a);
        else if ("wOFF" === x) {
          var S = en(y, 4);
        ...
        for (var k = 0; k < a; k += 1) {
          ...
          switch (T.tag) {
            case "cmap":
              U = rZ(y, T), m.tables.cmap = ei(U.data, U.offset), m.encoding = new ed(m.tables.cmap);
              break;
            case "cvt ":
              g = new et((U = rZ(y, T)).data, U.offset), m.tables.cvt = g.parseShortList(T.length / 2);
              break;
            case "fvar":
              s = T;
              break;
            case "fpgm":
              g = new et((U = rZ(y, T)).data, U.offset), m.tables.fpgm = g.parseByteList(T.length);
              break;
            case "head":
              U = rZ(y, T), m.tables.head = eP(U.data, U.offset), m.unitsPerEm = m.tables.head.unitsPerEm, r = m.tables.head.indexToLocFormat;
              break;
            case "hhea":
              U = rZ(y, T), m.tables.hhea = ez(U.data, U.offset), m.ascender = m.tables.hhea.ascender, m.descender = m.tables.hhea.descender, m.numberOfHMetrics = m.tables.hhea.numberOfHMetrics;
              break;
            case "hmtx":
              c = T;
              break;
            case "ltag":
              n = eX((U = rZ(y, T)).data, U.offset);
              break;
            case "maxp":
              U = rZ(y, T), m.tables.maxp = eV(U.data, U.offset), m.numGlyphs = m.tables.maxp.numGlyphs;
              break;
            case "name":
              d = T;
              break;
            case "OS/2":
              U = rZ(y, T), m.tables.os2 = e8(U.data, U.offset);
              break;
            case "post":
              U = rZ(y, T), m.tables.post = e9(U.data, U.offset), m.glyphNames = new eg(m.tables.post);
              break;
            case "prep":
              g = new et((U = rZ(y, T)).data, U.offset), m.tables.prep = g.parseByteList(T.length);
              break;
            case "glyf":
              i = T;
              break;
        ...
        var O = rZ(y, d);
        if (m.tables.name = e3(O.data, O.offset, n), m.names = m.tables.name, i && f) {
          var E = 0 === r,
            R = rZ(y, f),
            C = rY(R.data, R.offset, m.numGlyphs, E),
            L = rZ(y, i);
          m.glyphs = tU(L.data, L.offset, C, m, t)
        } else if (o) {
          var D = rZ(y, o);
          eF(D.data, D.offset, m, t)
        } else throw Error("Font doesn't contain TrueType or CFF outlines.");
        var w = rZ(y, c);
        if (eW(m, w.data, w.offset, m.numberOfHMetrics, m.numGlyphs, m.glyphs, t), t.lowMemory ? function(e) {
          ...
          var I = rZ(y, h);
          m.kerningPairs = rV(I.data, I.offset)
        } else m.kerningPairs = {};
        if (u) {
          var M = rZ(y, u);
          m.tables.gdef = rq(M.data, M.offset)
        }
        if (p) {
          var G = rZ(y, p);
          m.tables.gpos = rX(G.data, G.offset), m.position.init()
        }
        if (l) {
          var B = rZ(y, l);
          m.tables.gsub = tn(B.data, B.offset)
        }
        if (s) {
          var A = rZ(y, s);
          m.tables.fvar = rF(A.data, A.offset, m.names)
        }
        if (v) {
          var F = rZ(y, v);
          m.tables.meta = ta(F.data, F.offset), m.metas = m.tables.meta
        }
        return m
      }
    }
