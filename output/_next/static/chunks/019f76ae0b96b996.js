(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 90175, (e, t, r) => {
  ...
  i.ab = "/ROOT/frontend/node_modules/next/dist/compiled/process/", t.exports = i(229)
}, 39057, (e, t, r) => {
  "use strict";
  var n, o;
  ...
  function k(e, t, r) {
    ...
    return ! function e(t, r, n, u, s) {
      ...
      if (d) return s = s(t), d = "" === u ? "." + H(t, 0) : u, j(s) ? (n = "", null != d && (n = d.replace(C, "$&/") + "/"), e(s, r, n, "", function(e) {
        return e
      })) : null != s && (A(s) && (c = s, a = n + (null == s.key || t && t.key === s.key ? "" : ("" + s.key).replace(C, "$&/") + "/") + d, s = P(c.type, a, c.props)), r.push(s)), 1;
      d = 0;
      var p = "" === u ? "." : u + ":";
      if (j(t))
        for (var h = 0; h < t.length; h++) f = p + H(u = t[h], h), d += e(u, r, n, f, s);
      else if ("function" == typeof(h = null === (l = t) || "object" != typeof l ? null : "function" == typeof(l = v && l[v] || l["@@iterator"]) ? l : null))
        for (t = h.call(t), h = 0; !(u = t.next()).done;) f = p + H(u = u.value, h++), d += e(u, r, n, f, s);
      else if ("object" === f) {
  ...
  }, r.Component = S, r.Fragment = u, r.Profiler = c, r.PureComponent = E, r.StrictMode = s, r.Suspense = d, r.ViewTransition = g, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = R, r.__COMPILER_RUNTIME = {
    __proto__: null,
    c: function(e) {
  ...
  let n = "undefined" == typeof window ? e.r(26628).workAsyncStorage : void 0;
  ...
  let n = e.r(35856)._(e.r(30668)).default.createContext({})
}]);