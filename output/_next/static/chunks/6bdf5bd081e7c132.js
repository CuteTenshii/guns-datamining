(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 31100, e => {
  "use strict";
  let a = /\[(\d{1,3}):(\d{2})(?:\.(\d{1,3}))?\]/g,
    c = /<(\d{1,3}):(\d{2})(?:\.(\d{1,3}))?>/g;

  function t(e, a, c = "0") {
    let l = Number(e || 0),
      s = Number(a || 0),
      i = Number((c + "00").slice(0, 3));
    return Number.isFinite(l) && Number.isFinite(s) && Number.isFinite(i) ? Math.max(0, (60 * l + s) * 1e3 + i) : null
  }

  function l(e) {
    return String(e || "").replace(a, "").replace(c, "").replace(/\s+/g, " ").trim()
  }

  function s(e) {
    if (!e) return [];
    let s = [];
    for (let i of String(e).split(/\r?\n/)) {
      let e = i.trim();
      if (!e) continue;
      let r = Array.from(e.matchAll(a));
      if (0 === r.length) continue;
      let h = e.replace(a, "").trim(),
        o = l(h) || "...",
        n = function(e) {
          let a = Array.from(e.matchAll(c));
          ...
          for (let c = 0; c < a.length; c++) {
            let s = a[c],
              i = a[c + 1],
              r = t(s[1], s[2], s[3] || "0");
            if (null === r || "number" != typeof s.index) continue;
            let h = s.index + s[0].length,
              o = "number" == typeof i?.index ? i.index : e.length,
              n = e.slice(h, o).replace(/\s+/g, " ").trim();
            n && l.push({
              timeMs: r,
              text: n
            })
    ...
    return s.sort((e, a) => e.timeMs - a.timeMs)
  }
  ...
  function h(e) {
    ...
    let s = c.sort((e, a) => e.timeMs - a.timeMs);
    return 0 === s.length ? null : {
      syncedLyrics: s.map(e => {
        let a, c, t;
        return `${c=Math.floor((a=Math.max(0,Math.floor(e.timeMs)))/6e4),t=Math.floor(a%6e4/1e3),`[${String(c).padStart(2,"0")}:${String(t).padStart(2,"0")}.${String(a%1e3).padStart(3,"0")}]`} ${e.syncedText}`
      }).join("\n"),
      plainLyrics: s.map(e => e.plainText).join("\n"),
      lineCount: s.length
    }
  }
  e.s(["findActiveLyricIndex", () => i, "findActiveLyricWordIndex", () => r, "parseLrcFile", () => h, "parseSyncedLyrics", () => s])
}, 94315, 2397, e => {
  "use strict";
  let a = [{
    id: "python",
  ...
  function c(e) {
    ...
    return a.find(e => e.name.toLowerCase() === c || e.id === c || e.aliases?.some(e => e.toLowerCase() === c))
  }

  function t(e, c = 8) {
    if (!e.trim()) return [];
    let l = e.trim().toLowerCase(),
      s = a.map(e => e.name.toLowerCase() === l || e.id === l ? {
        s: e,
        score: 3
      } : e.name.toLowerCase().startsWith(l) || e.id.startsWith(l) ? {
        s: e,
        score: 2
      } : e.aliases?.some(e => e.toLowerCase().startsWith(l)) ? {
        s: e,
        score: 1.5
      } : e.name.toLowerCase().includes(l) || e.aliases?.some(e => e.toLowerCase().includes(l)) ? {
        s: e,
        score: 1
      } : {
        s: e,
    ...
    return s.sort((e, a) => a.score - e.score), s.slice(0, c).map(e => e.s)
  }
  e.s(["findSkillByName", () => c, "searchSkills", () => t], 94315);
  let l = '<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>',
    s = '</title><path d="',
    i = '"/></svg>',
    r = {
      title: "React",
    ...
    o = {
      ...
      javascript: h({
        ...
        slug: "javascript",
        get svg() {
          return l + "JavaScript" + s + this.path + i
        },
      ...
      typescript: h({
        ...
        slug: "typescript",
        get svg() {
          return l + "TypeScript" + s + this.path + i
        },
      ...
      java: h({
        ...
        slug: "openjdk",
        get svg() {
          return l + "OpenJDK" + s + this.path + i
        },
      ...
      ruby: h({
        ...
        license: {
          type: "CC-BY-SA-2.5",
          url: "https://spdx.org/licenses/CC-BY-SA-2.5"
        }
      }),
      php: h({
        title: "PHP",
      ...
      haskell: h({
        ...
        slug: "haskell",
        get svg() {
          return l + "Haskell" + s + this.path + i
        },
      ...
      nextjs: h({
        ...
        slug: "nextdotjs",
        get svg() {
          return l + "Next.js" + s + this.path + i
        },
      ...
      angular: h({
        ...
        slug: "angular",
        get svg() {
          return l + "Angular" + s + this.path + i
        },
      ...
      nodejs: h({
        ...
        slug: "nodedotjs",
        get svg() {
          return l + "Node.js" + s + this.path + i
        },
      ...
      express: h({
        ...
        slug: "express",
        get svg() {
          return l + "Express" + s + this.path + i
        },
      ...
      fastapi: h({
        ...
        slug: "fastapi",
        get svg() {
          return l + "FastAPI" + s + this.path + i
        },
      ...
      rails: h({
        ...
        slug: "rubyonrails",
        get svg() {
          return l + "Ruby on Rails" + s + this.path + i
        },
      ...
      laravel: h({
        ...
        slug: "laravel",
        get svg() {
          return l + "Laravel" + s + this.path + i
        },
      ...
      postgresql: h({
        ...
        slug: "postgresql",
        get svg() {
          return l + "PostgreSQL" + s + this.path + i
        },
      ...
      mongodb: h({
        ...
        slug: "mongodb",
        get svg() {
          return l + "MongoDB" + s + this.path + i
        },
      ...
      supabase: h({
        ...
        slug: "supabase",
        get svg() {
          return l + "Supabase" + s + this.path + i
        },
      ...
      firebase: h({
        ...
        slug: "firebase",
        get svg() {
          return l + "Firebase" + s + this.path + i
        },
      ...
      planetscale: h({
        ...
        slug: "planetscale",
        get svg() {
          return l + "PlanetScale" + s + this.path + i
        },
      ...
      clickhouse: h({
        ...
        slug: "clickhouse",
        get svg() {
          return l + "ClickHouse" + s + this.path + i
        },
      ...
      kubernetes: h({
        ...
        slug: "kubernetes",
        get svg() {
          return l + "Kubernetes" + s + this.path + i
        },
      ...
      gcp: h({
        ...
        slug: "googlecloud",
        get svg() {
          return l + "Google Cloud" + s + this.path + i
        },
      ...
      cloudflare: h({
        ...
        slug: "cloudflare",
        get svg() {
          return l + "Cloudflare" + s + this.path + i
        },
      ...
      terraform: h({
        ...
        slug: "terraform",
        get svg() {
          return l + "Terraform" + s + this.path + i
        },
      ...
      "github-actions": h({
        ...
        slug: "githubactions",
        get svg() {
          return l + "GitHub Actions" + s + this.path + i
        },
      ...
      tailwind: h({
        ...
        slug: "tailwindcss",
        get svg() {
          return l + "Tailwind CSS" + s + this.path + i
        },
      ...
      shadcn: h({
        ...
        slug: "shadcnui",
        get svg() {
          return l + "shadcn/ui" + s + this.path + i
        },
      ...
      three: h({
        ...
        slug: "threedotjs",
        get svg() {
          return l + "Three.js" + s + this.path + i
        },
      ...
      pytorch: h({
        ...
        slug: "pytorch",
        get svg() {
          return l + "PyTorch" + s + this.path + i
        },
      ...
      tensorflow: h({
        ...
        slug: "tensorflow",
        get svg() {
          return l + "TensorFlow" + s + this.path + i
        },
      ...
      langchain: h({
        ...
        slug: "langchain",
        get svg() {
          return l + "LangChain" + s + this.path + i
        },
      ...
      graphql: h({
        ...
        slug: "graphql",
        get svg() {
          return l + "GraphQL" + s + this.path + i
        },
      ...
      drizzle: h({
        ...
        slug: "drizzle",
        get svg() {
          return l + "Drizzle" + s + this.path + i
        },
      ...
      blender: h({
        ...
        slug: "blender",
        get svg() {
          return l + "Blender" + s + this.path + i
        },
      ...
      unreal: h({
        ...
        slug: "unrealengine",
        get svg() {
          return l + "Unreal Engine" + s + this.path + i
        },
      ...
      flutter: h({
        ...
        slug: "flutter",
        get svg() {
          return l + "Flutter" + s + this.path + i
        },
      ...
      electron: h({
        ...
        slug: "electron",
        get svg() {
          return l + "Electron" + s + this.path + i
        },
      ...
      wasm: h({
        ...
        slug: "webassembly",
        get svg() {
          return l + "WebAssembly" + s + this.path + i
        },
      ...
      kafka: h({
        ...
        slug: "apachekafka",
        get svg() {
          return l + "Apache Kafka" + s + this.path + i
        },
      ...
      rabbitmq: h({
        ...
        slug: "rabbitmq",
        get svg() {
          return l + "RabbitMQ" + s + this.path + i
        },
  ...
  function n(e) {
    let a = "string" == typeof e ? c(e) : e;
    return a ? o[a.id] : void 0
  }
  e.s(["getSkillIcon", () => n], 2397)
}]);