...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3957], {
    17440: (e, a, o) => {
      ...
      let l = e => ({
        ...
        n = {
          ...
          cloudflare: l(i.abC),
          terraform: l(i.Bn8),
          "github-actions": l(i.DVO),
          linux: l(i.Z0w),
          tailwind: l(i.AN7),
          css: l(i.QBF),
          sass: l(i.$EC),
          shadcn: l(i.__M),
          "framer-motion": l(i.W4B),
          three: l(i.HVl),
          pytorch: l(i.glI),
          tensorflow: l(i.Md3),
          langchain: l(i.G9w),
    ...
    55442: (e, a, o) => {
      ...
      function c(e, a) {
        if (!e || 0 === e.length || !Number.isFinite(a) || a < 0) return -1;
        let o = 1e3 * a,
          i = -1;
        for (let a = 0; a < e.length; a++)
          if (e[a].timeMs <= o) i = a;
      ...
      function m(e) {
        ...
        let o = a.sort((e, a) => e.timeMs - a.timeMs);
        return 0 === o.length ? null : {
          syncedLyrics: o.map(e => {
            let a, o, i;
            return `${o=Math.floor((a=Math.max(0,Math.floor(e.timeMs)))/6e4),i=Math.floor(a%6e4/1e3),`[${String(o).padStart(2,"0")}:${String(i).padStart(2,"0")}.${String(a%1e3).padStart(3,"0")}]`} ${e.syncedText}`
          }).join("\n"),
          plainLyrics: o.map(e => e.plainText).join("\n"),
          lineCount: o.length
        }
      }
    },
    77599: (e, a, o) => {
      ...
      function r(e) {
        ...
        return i.find(e => e.name.toLowerCase() === a || e.id === a || e.aliases?.some(e => e.toLowerCase() === a))
      }

      function l(e, a = 8) {
        if (!e.trim()) return [];
        let o = e.trim().toLowerCase(),
          r = i.map(e => e.name.toLowerCase() === o || e.id === o ? {
            s: e,
            score: 3
