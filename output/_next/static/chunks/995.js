    ...
    44822: (e, t, r) => {
      ...
      function d(e) {
        ...
        (0, n.useEffect)(function() {
          return j.current = new o.default(v.current, S()), j.current.render(), O.current = b,
            function() {
              j.current && "function" == typeof j.current.destroy && j.current.destroy()
            }
        }, []), (0, n.useEffect)(function() {
          if (j.current && j.current.w) {
            var e = !y(j.current.w.config.series, d),
              t = !y(O.current, b) || l !== j.current.opts.chart.height || a !== j.current.opts.chart.width;
            (e || t) && (e ? t ? j.current.updateOptions(S()) : j.current.updateSeries(d) : j.current.updateOptions(S())), O.current = b
          }
        }, [b, d, l, a]);
        var P, T = (P = s({}, m), h.forEach(function(e) {
          delete P[e]
        }), P);
