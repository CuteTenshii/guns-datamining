      ...
      var a = r(97650),
        ...
        o = class e {
          ...
          set fullscreenMaterial(t) {
            let r = this.screen;
            null !== r ? r.material = t : ((r = new a.eaF(e.fullscreenGeometry, t)).frustumCulled = !1, null === this.scene && (this.scene = new a.Z58), this.scene.add(r), this.screen = r)
          }
          ...
          dispose() {
            for (let t of Object.keys(this)) {
              let r = this[t];
              (r instanceof a.nWS || r instanceof a.imn || r instanceof a.gPd || r instanceof e) && this[t].dispose()
            }
...
gl_FragDepth=readDepth(vUv);
        ...
        d = class extends a.BKk {
          constructor() {
            super({
              ...
              uniforms: {
                inputBuffer: new a.nc$(null),
                depthBuffer: new a.nc$(null),
                channelWeights: new a.nc$(null),
                opacity: new a.nc$(1)
              },
              blending: a.XIg,
              toneMapped: !1,
          ...
          set channelWeights(e) {
            null !== e ? (this.defines.USE_WEIGHTS = "1", this.uniforms.channelWeights.value = e) : delete this.defines.USE_WEIGHTS, this.needsUpdate = !0
          }
          setInputBuffer(e) {
        ...
        T = class {
          ...
          cloneMaterial(e) {
            if (!(e instanceof a.BKk)) return e.clone();
            let t = e.uniforms,
              r = new Map;
            for (let e in t) {
              let s = t[e].value;
          ...
          setMaterial(e) {
            if (this.disposeMaterials(), this.material = e, null !== e) {
              ...
              for (let r of t) r.uniforms = Object.assign({}, e.uniforms), r.side = a.hB5;
              t[2].skinning = !0, this.materialsBackSide = t.map(t => {
                let r = this.cloneMaterial(t);
                return r.uniforms = Object.assign({}, e.uniforms), r.side = a.hsX, r
              }), this.materialsDoubleSide = t.map(t => {
                let r = this.cloneMaterial(t);
                return r.uniforms = Object.assign({}, e.uniforms), r.side = a.$EB, r
                ...
                let r = this.cloneMaterial(t);
                return r.uniforms = Object.assign({}, e.uniforms), r.flatShading = !0, r.side = a.hsX, r
              }), this.materialsFlatShadedDoubleSide = t.map(t => {
                let r = this.cloneMaterial(t);
                return r.uniforms = Object.assign({}, e.uniforms), r.flatShading = !0, r.side = a.$EB, r
              })
            }
          }
          render(e, t, r) {
          ...
          disposeMaterials() {
            if (null !== this.material)
              for (let e of this.materials.concat(this.materialsBackSide).concat(this.materialsDoubleSide).concat(this.materialsFlatShaded).concat(this.materialsFlatShadedBackSide).concat(this.materialsFlatShadedDoubleSide)) e.dispose()
          }
          dispose() {
        ...
        P = class extends a.BKk {
          constructor(e = !1, t = null) {
            super({
              ...
              defines: {
                THREE_REVISION: a.sPf.replace(/\D+/g, "")
              },
              uniforms: {
                inputBuffer: new a.nc$(null),
                threshold: new a.nc$(0),
                smoothing: new a.nc$(1),
                range: new a.nc$(null)
              },
              blending: a.XIg,
              toneMapped: !1,
...
#include <colorspace_fragment>
        ...
        I = `#ifdef FRAMEBUFFER_PRECISION_HIGH
        ...
        k = class extends o {
          ...
          initialize(e, t, r) {
            if (void 0 !== r) {
              ...
              if (r !== a.OUM) this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1";
              else if (null !== e && e.outputColorSpace === a.er$)
                for (let e of t) e.texture.colorSpace = a.er$
            }
          }
          dispose() {
...
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv)*intensity;}`,
        G = class extends A {
          ...
          initialize(e, t, r) {
            this.blurPass.initialize(e, t, r), this.luminancePass.initialize(e, t, r), this.mipmapBlurPass.initialize(e, t, r), void 0 !== r && (this.renderTarget.texture.type = r, null !== e && e.outputColorSpace === a.er$ && (this.renderTarget.texture.colorSpace = a.er$))
          }
        };
      a.BKk;
      a.BKk;
      ...
      var W = class e {
        ...
        $ = new a.Q1f;
      (class e extends a.dYF {
        constructor(e, t) {
          super(e, t, t, t), this.type = a.RQf, this.format = a.GWd, this.minFilter = a.k6q, this.magFilter = a.k6q, this.wrapS = a.ghU, this.wrapT = a.ghU, this.wrapR = a.ghU, this.unpackAlignment = 1, this.needsUpdate = !0, this.colorSpace = a.Zr2, this.domainMin = new a.Pq0(0, 0, 0), this.domainMax = new a.Pq0(1, 1, 1)
        }
        ...
        convertLinearToSRGB() {
          let e = this.image.data;
          if (this.type === a.RQf) {
            for (let t = 0, r = e.length; t < r; t += 4) $.fromArray(e, t).convertLinearToSRGB().toArray(e, t);
            this.colorSpace = a.er$, this.needsUpdate = !0
        ...
        convertSRGBToLinear() {
          let e = this.image.data;
          if (this.type === a.RQf) {
            for (let t = 0, r = e.length; t < r; t += 4) $.fromArray(e, t).convertSRGBToLinear().toArray(e, t);
            this.colorSpace = a.Zr2, this.needsUpdate = !0
          } else console.error("Color space conversion requires FloatType data");
          return this
        }
        toDataTexture() {
          let e = this.image.width,
            ...
            r = new a.GYF(this.image.data, e, t);
      ...
      var V = `void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 noise=vec3(rand(uv*(1.0+time)));
#ifdef PREMULTIPLY
...
vec2 sl=vec2(sin(y*count),cos(y*count));outputColor=vec4(sl.xyx,inputColor.a);}`,
        Y = class extends A {
          constructor({
            ...
            super("ScanlineEffect", X, {
              blendFunction: e,
              uniforms: new Map([
                ["count", new a.nc$(0)],
                ["scrollSpeed", new a.nc$(0)]
              ])
            }), this.resolution = new a.I9Y, this.d = t, this.scrollSpeed = r
          }
          get density() {
            return this.d
          }
...
gl_FragColor=vec4(n[index],d[index]);}`,
        ...
        j = class extends o {
          constructor({
            ...
            const l = new Q;
            l.normalBuffer = e, this.fullscreenMaterial = l, this.needsDepthTexture = !0, this.needsSwap = !1, this.renderTarget = new a.nWS(1, 1, {
              minFilter: a.hxR,
              magFilter: a.hxR,
              depthBuffer: !1,
              type: a.RQf
...
#include <colorspace_fragment>
        ...
        et = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform vec2 maskParams;varying vec2 vUv2;float linearGradientMask(const in float x){return step(maskParams.x,x)-step(maskParams.y,x);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float mask=linearGradientMask(vUv2.y);vec4 texel=texture2D(map,uv);outputColor=mix(texel,inputColor,mask);}`,
        er = class extends A {
          ...
          initialize(e, t, r) {
            this.blurPass.initialize(e, t, r), void 0 !== r && (this.renderTarget.texture.type = r, null !== e && e.outputColorSpace === a.er$ && (this.renderTarget.texture.colorSpace = a.er$))
          }
        };
      a.BKk;
      a.BKk;
...
#include <dithering_fragment>
        ...
        ei = class extends a.BKk {
          constructor(e, t, r, s, i = !1) {
            super({
              ...
              uniforms: {
                inputBuffer: new a.nc$(null),
                depthBuffer: new a.nc$(null),
                resolution: new a.nc$(new a.I9Y),
                texelSize: new a.nc$(new a.I9Y),
                cameraNear: new a.nc$(.3),
                cameraFar: new a.nc$(1e3),
                aspect: new a.nc$(1),
                time: new a.nc$(0)
              },
              blending: a.XIg,
          ...
          copyCameraSettings(e) {
            e && (this.uniforms.cameraNear.value = e.near, this.uniforms.cameraFar.value = e.far, e instanceof a.ubm ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0)
          }
          setSize(e, t) {
            let r = this.uniforms;
