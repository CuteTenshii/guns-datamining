  ...
  [8305], {
    ...
    28305: (e, t, r) => {
      ...
      let o = ({
        ...
        let [d, u] = (0, a.useState)(!1), [m, p] = (0, a.useState)(null), f = (0, a.useRef)(null), h = "string" == typeof r, g = h ? "" !== r : r.length > 0;
        ...
        }, [r, t, h, g]), (0, s.jsxs)(s.Fragment, {
          children: [d && "" !== e ? (0, s.jsx)("video", {
            src: e,
            playsInline: !0,
            loop: !0,
      ...
      function l({
        ...
        (0, a.useEffect)(() => () => {
          v(f), v(h), t.current && g.current && t.current.removeEventListener("timeupdate", g.current)
        }, [t]);
        let y = e => {
          if (e) {
            if (e === i().fadeUp || e === i().scaleFade) {
              o.current?.classList.add(e), d.current?.classList.add(e), u?.current?.classList.add(e);
              return
            }
        ...
        (0, a.useEffect)(() => {
          p.current && l && l !== x.current && (y(l), x.current = l)
        }, [l]);
        let j = (e, t = !1, r) => {
          let s = t ? h : f;
          v(s);
          let a = 0,
            n = e => {
              if (t && e instanceof HTMLAudioElement) {
                let t;
                b(e), g.current && e.removeEventListener("timeupdate", g.current), g.current = t = () => b(e), e.addEventListener("timeupdate", t)
              }
            },
            i = e => {
              e.volume = .25;
            ...
            o = (e = !1) => {
              a >= 40 || (a += 1, v(s), s.current.timeoutId = window.setTimeout(() => {
                s.current.timeoutId = void 0, l(e)
              }, 350))
            },
            l = (t = !1) => {
              let r = e.current;
        ...
        return (0, s.jsx)(s.Fragment, {
          children: (0, s.jsx)("div", {
            ...
            onClick: () => {
              p.current || (m.current && (m.current.classList.add(i().hide), m.current.style.pointerEvents = "none", setTimeout(() => {
                m.current && (m.current.style.display = "none")
              }, 650)), y(l), x.current = l, p.current = !0), j(e, !1, {
                eager: !0
              }), j(t, !0, {
                eager: !0
              })
      ...
      let c = {
        ...
        p = e => {
          ...
          return Object.keys(c).reduce((e, r) => {
            ...
            return e[r] = {
              ...n,
              fontSize: `${parseFloat(n.fontSize)*s}px`
            }, e
          }, {})
        };
      var f = r(65596),
...
`;
      ...
      function N({
        ...
        (0, a.useEffect)(() => {
          let e = g.getPixelRatio(),
            t = Math.floor(f.width * e),
            r = Math.floor(f.height * e),
            s = v.current.resolution.value;
          (s.x !== t || s.y !== r) && s.set(t, r)
        }, [f, g]);
        let _ = (0, a.useRef)([...n]);
        return (0, h.D)(({
          clock: s
          ...
          let a = v.current;
          l || (a.time.value = s.getElapsedTime()), a.waveSpeed.value !== e && (a.waveSpeed.value = e), a.waveFrequency.value !== t && (a.waveFrequency.value = t), a.waveAmplitude.value !== r && (a.waveAmplitude.value = r), _.current.every((e, t) => e === n[t]) || (a.waveColor.value.set(...n), _.current = [...n]), a.enableMouseInteraction.value = +!!c, a.mouseRadius.value = d, c && a.mousePos.value.copy(m.current)
        }), (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsxs)("mesh", {
            ref: u,
            scale: [p.width, p.height, 1],
            children: [(0, s.jsx)("planeGeometry", {
              args: [1, 1]
            }), (0, s.jsx)("shaderMaterial", {
              vertexShader: y,
              fragmentShader: j,
              uniforms: v.current
            })]
            ...
            onPointerMove: e => {
              if (!c) return;
              let t = g.domElement.getBoundingClientRect(),
                r = g.getPixelRatio();
        ...
        return (0, a.useEffect)(() => {
          ...
          e = new T.B(l, {
            ...
            uniforms: {
              ...
              uResolution: {
                value: [s.offsetWidth, s.offsetHeight]
              },
              uBlend: {
                value: n
              }
          ...
          return p = requestAnimationFrame(f), c(), () => {
            cancelAnimationFrame(p), window.removeEventListener("resize", c), s && l.canvas.parentNode === s && s.removeChild(l.canvas), l.getExtension("WEBGL_lose_context")?.loseContext()
          }
        }, [r]), (0, s.jsx)("div", {
          ref: o,
        ...
        D = ({
          ...
          return (0, a.useEffect)(() => {
            ...
            let a = l.current,
              ...
              u = +!!e,
              m = e ? (s = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(e)) ? [parseInt(s[1], 16) / 255, parseInt(s[2], 16) / 255, parseInt(s[3], 16) / 255] : [1, .5, .2] : [1, 1, 1],
              p = "reverse" === r ? -1 : 1,
              f = new $.A({
                webgl: 2,
                alpha: !0,
            ...
            o && l.current.addEventListener("mousemove", y);
            let j = () => {
                let e = l.current.getBoundingClientRect(),
                  t = Math.max(1, Math.floor(e.width)),
                  r = Math.max(1, Math.floor(e.height));
                f.setSize(t, r);
                let s = v.uniforms.iResolution.value;
                s[0] = h.drawingBufferWidth, s[1] = h.drawingBufferHeight
              },
            ...
            return S = requestAnimationFrame(N), () => {
              cancelAnimationFrame(S), _.disconnect(), o && a.removeEventListener("mousemove", y), d()
            }
          }, [e, t, r, n, i, o]), (0, s.jsx)("div", {
            ref: l,
  ...
  gl_FragColor = vec4(1.0);
        ...
        G = (e, t, r) => {
          try {
            ...
            if (!s || !a) return !1;
            e.shaderSource(s, t), e.shaderSource(a, r), e.compileShader(s), e.compileShader(a);
            let n = e.getShaderParameter(s, e.COMPILE_STATUS),
              i = e.getShaderParameter(a, e.COMPILE_STATUS);
            if (!n || !i) return e.deleteShader(s), e.deleteShader(a), !1;
            let o = e.createProgram();
            if (!o) return e.deleteShader(s), e.deleteShader(a), !1;
            e.attachShader(o, s), e.attachShader(o, a), e.linkProgram(o);
            let l = e.getProgramParameter(o, e.LINK_STATUS);
            return e.deleteShader(s), e.deleteShader(a), e.deleteProgram(o), !!l
          } catch {
            return !1
          }
        };
      ...
      function O({
        ...
        let c = ((e, t) => {
            let r, {
              ...
              r: (r = parseInt(e.replace("#", ""), 16)) >> 16 & 255,
              g: r >> 8 & 255,
              b: 255 & r
            };
            return {
              r: Math.max(0, Math.floor(.2 * s)),
              g: Math.max(0, Math.floor(.2 * a)),
              b: Math.max(0, Math.floor(.2 * n))
            }
          })(n, 0),
          [d, u] = (0, a.useState)(R),
          [m, p] = (0, a.useState)(!1);
        (0, a.useEffect)(() => {
          let e, t, r, s, a, n = !1,
            ...
            })) && G(e, E, L)), e?.getExtension("WEBGL_lose_context")?.loseContext(), s = (r = document.createElement("canvas")).getContext("webgl", {
              failIfMajorPerformanceCaveat: !0
            }) || r.getContext("experimental-webgl"), a = t || !!(s && G(s, F, M)), s?.getExtension("WEBGL_lose_context")?.loseContext(), {
              aurora: t,
              plasma: t,
              dither: a
            });
        ...
        let g = "dither" === e && d.dither,
          x = "aurora" === e && d.aurora,
          v = "plasma" === e && d.plasma;
        return (0, s.jsxs)(s.Fragment, {
          children: ["snowflakes" === e ? (0, s.jsx)(s.Fragment, {
            ...
            waveColor: [c.r / 100, c.g / 100, c.b / 100],
            disableAnimation: !1,
            ...
            children: `
                    * {
                      cursor: url(${l}) 16 16, auto !important;
                    }
                    `
          }), (0, s.jsx)("style", {
            children: `
      ...
      let K = ({
        ...
        let r = e.user_badges,
          a = e.custom_badges,
          n = r.length > 0 && r[0] && "string" == typeof r[0],
          o = a.length > 0 && "string" == typeof a[0][0],
          l = {
            staff: "Staff",
            premium: "Premium",
            verified: "Verified",
        ...
        return (0, s.jsx)(s.Fragment, {
          children: (0, s.jsxs)("div", {
            ...
            children: [n ? r.map(r => {
              ...
              return (0, s.jsx)(X.A, {
                ...
                children: (0, s.jsxs)("div", {
                  ...
                  children: [t.monochrome_badges && n && (0, s.jsx)("style", {
                    children: `
                    .${n} {
              ...
              return (0, s.jsx)(X.A, {
                ...
                children: (0, s.jsxs)("div", {
                  className: i().badgeContainerFlex,
                  children: [t.monochrome_badges && o && (0, s.jsx)("style", {
                    children: `
                    .${o} {
                        color: ${t.badge_color}!important;
                        filter: drop-shadow(${t.badge_color} 0 0 2.5px)!important;
            ...
            }), 0 !== a.length && (0, s.jsx)(s.Fragment, {
              children: o ? a.map((e, t) => (0, s.jsx)(X.A, {
                content: e[0],
                pageTooltipStyles: !0,
                children: (0, s.jsx)("div", {
                  className: i().badgeContainerFlex,
              ...
              }, t)) : a.map((e, t) => e.enabled && (0, s.jsx)(X.A, {
                content: e.name,
                pageTooltipStyles: !0,
                children: (0, s.jsx)("div", {
                  className: i().badgeContainerFlex,
      ...
      var ee = r(52131),
        ...
        ei = r(99387),
        eo = r(57776);
      let el = (0, ea.default)(() => r.e(1045).then(r.bind(r, 31045)), {
          loadableGenerated: {
            webpack: () => [31045]
          },
          ssr: !1
      ...
      function ed({
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsx)(eo.A, {
            ...
            children: "custom_url" === y ? (0, s.jsxs)("div", {
              ...
              return (0, s.jsxs)("div", {
                ...
                children: [t ? t && (0, s.jsx)("style", {
                  ...
                  children: `
                            ...
                            `
                }), m.includes(e.social) ? (o = S.includes(e.id), (0, s.jsx)(ei.A, {
                  value: e.value,
                  children: ({
                    copied: r,
                    copy: a
                    ...
                    children: (0, s.jsx)("span", {
                      ...
                      children: "monero" === e.social && t ? ee.A.moneroMonochrome : ee.A[e.social]
                    })
                  })
                })) : (l = ee.A[e.social.replace("custom_url", "customUrl")], d = e.mode ?? "link", u = es.V$[e.social], p = S.includes(e.id), f = (e => {
          ...
          children: (0, s.jsx)("div", {
            ...
            children: e.success && m && !c ? (0, s.jsxs)("div", {
                ...
                children: [(0, s.jsxs)("div", {
                  ...
                  children: [(0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)("span", {
                      ...
                      children: n.map((e, t) => (0, s.jsx)(X.A, {
                        content: e,
                        pageTooltipStyles: !0,
                        children: (0, s.jsx)("div", {
                  ...
                  }) : 2 !== m.type || f ? f ? (0, s.jsx)(X.A, {
                    content: `Listening to ${f.details} ${f.state&&`by ${f.state.replace(/;/g,",")}`}`,
                    pageTooltipStyles: !0,
                    children: (0, s.jsx)("img", {
                      src: f.image,
                      alt: ""
                    })
                  }) : "offline" === m.status && null : m.image && "{}" !== JSON.stringify(m.image) && (0, s.jsx)(X.A, {
                    content: `${d[m.type]} ${m.name}`,
                    pageTooltipStyles: !0,
                    children: (0, s.jsx)("img", {
                      src: m.image,
              ...
              children: [(0, s.jsxs)("h1", {
                ...
                style: h.discordStatus,
                children: ["Join ", (0, s.jsx)(er(), {
                ...
                children: [(0, s.jsxs)("div", {
                  ...
                  children: [(0, s.jsxs)("div", {
                    ...
                    children: "offline" === e.status ? (0, s.jsxs)("span", {
                      ...
                      children: l.idle_text || "currently doing nothing"
                    })
                  })]
                }), (0, s.jsx)("div", {
                  className: i().activityImage
    ...
    `.replace(/\/\*[\s\S]*?\*\//g, "").replace(/(^|[^:])\/\/.*$/gm, "$1").split("\n").map(e => e.trim()).filter(Boolean).join("").replace(/\s+/g, " ");
      ...
      function eh({
        ...
        return (0, a.useEffect)(() => {
          ...
          let e = setInterval(() => {
            v && "" !== y && !u && (fetch("https://guns.lol/api/analytics/record", {
              cache: "no-store",
              body: JSON.stringify({
                _t: y,
          ...
          children: [(0, s.jsx)(ep, {
          ...
          }), !r.hide_views && !l && (0, s.jsx)("div", {
            className: `${i().profileViews} ${c&&d}`,
            style: {
              bottom: N ? 12 + N : 12,
              left: N ? 15 + N : 15
            },
            children: (0, s.jsx)(X.A, {
              ...
              children: (0, s.jsxs)("span", {
                ...
                children: [H.A.profileViews, " ", n.toLocaleString("en-US")]
              })
            })
          })]
        })
      ...
      function ex({
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsxs)("div", {
            className: J().userInformation,
            children: ["" !== r.banner && (0, s.jsx)("img", {
              src: r.banner,
              alt: "",
              className: J().banner
            }), A ? (0, s.jsxs)("div", {
              ...
              children: [(0, s.jsx)(X.A, {
                ...
                offset: 0,
                pageTooltipStyles: !0,
                children: "typewriter" === t.username_effects ? (0, s.jsxs)(s.Fragment, {
                ...
                className: J().userDescriptionText,
                style: c.description,
                ...
                children: (0, s.jsxs)("span", {
                  ...
                  children: [H.A.locationMarker, " ", t.location]
                })
              })]
      ...
      function ej({
        ...
        let n = p({
          ...
          [x, v] = (0, a.useState)({}),
          [b, y] = (0, a.useState)(!0),
          j = Object.keys(t.second_tab)[0],
          _ = !!t.second_tab_enabled && "enabled" !== e.presence,
          S = async () => {
            try {
              let e = `https://discord.com/api/v9/invites/${T(t.second_tab.discord)}?with_counts=true`,
                r = await fetch(e);
              if (!r.ok) {
                o({
                  error: !0,
              ...
              let s = await r.json(),
                ...
                n = s.guild.features.includes("PARTNERED");
              o({
                ...s,
                isVerified: a,
                isPartnered: n
              ...
              children: [(0, s.jsxs)("div", {
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [(0, s.jsxs)("h1", {
                    ...
                    style: n.memberCount,
                    children: [(0, s.jsxs)("span", {
                      children: [H.A.status, " ", i.approximate_presence_count?.toLocaleString("en-US"), " Online"]
                    }), (0, s.jsxs)("span", {
                      children: [H.A.status, " ", i.approximate_member_count?.toLocaleString("en-US"), " Members"]
                    })]
                  }), !_ && (0, s.jsx)(er(), {
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [l.error ? (0, s.jsxs)(s.Fragment, {
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: (0, s.jsx)("span", {
                    ...
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: [(0, s.jsxs)("span", {
                        children: [H.A.followers, " ", l.followers?.toLocaleString("en-US"), " Followers"]
                      }), (0, s.jsxs)("span", {
                        children: [H.A.repositories, " ", l.repositories?.toLocaleString("en-US"), " Repos"]
                      })]
                    })]
                  }), (0, s.jsx)(er(), {
                    href: `https://github.com/${l.username}`,
                    target: "_blank",
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [m.error ? (0, s.jsxs)(s.Fragment, {
                    ...
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: [(0, s.jsxs)("span", {
                        children: [H.A.friends, " ", m.friends?.toLocaleString("en-US"), " Friends"]
                      }), (0, s.jsxs)("span", {
                        children: [H.A.followers, " ", m.followers?.toLocaleString("en-US"), " Followers"]
                      })]
                    })]
                  }), (0, s.jsx)(er(), {
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [d.error ? (0, s.jsxs)(s.Fragment, {
                    ...
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: (0, s.jsxs)("span", {
                        children: [H.A.followers, " ", d.members?.toLocaleString("en-US"), " Subscribers"]
                      })
                    })]
                  }), (0, s.jsx)(er(), {
                    href: `https://t.me/${U(t.second_tab.telegram)}`,
                    target: "_blank",
                    style: n.secondTabWidgetButton,
                    children: "Join"
                  })]
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [h.error ? (0, s.jsxs)(s.Fragment, {
                    ...
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: (0, s.jsxs)("span", {
                        children: [H.A.followers, " ", (r = h.subscribers) >= 1e6 ? (r / 1e6).toFixed(1) + "M" : r >= 1e3 ? (r / 1e3).toFixed(1) + "K" : r, " Subscribers"]
                      })
                    })]
                  }), (0, s.jsx)(er(), {
                    href: `https://youtube.com/channel/${h.channelId}`,
                    target: "_blank",
                    style: n.secondTabWidgetButton,
                ...
                children: [(0, s.jsx)("div", {
                  ...
                  children: [x.error ? (0, s.jsxs)(s.Fragment, {
                    ...
                    children: [(0, s.jsx)("h1", {
                      ...
                      style: n.secondTabWidgetDescription,
                      children: [(0, s.jsxs)("span", {
                        children: [H.A.playCount, " ", Number(x.playcount)?.toLocaleString("en-US"), " Scrobbles"]
                      }), (0, s.jsxs)("span", {
                        children: [H.A.artistCount, " ", Number(x.artistCount)?.toLocaleString("en-US"), " Artists"]
                      })]
                    })]
                  }), (0, s.jsx)(er(), {
                    href: `https://last.fm/user/${P(t.second_tab.lastfm)}`,
                    target: "_blank",
                    style: n.secondTabWidgetButton,
                    children: "View Profile"
                  })]
      ...
      function e$({
        ...
        let f = e => {
          ...
          g = f(t.currentTime),
          x = f(t.duration),
          v = t.currentTime / t.duration * 100,
          b = (0, a.useRef)(!1),
          y = e => {
            let t = e.play();
              ...
              n = () => {
                y(s).then(e => {
                  e && (o(e => ({
                    ...
                    muted: !1,
                    volume: 100
                  }), s.addEventListener("timeupdate", a))
                }), s.removeEventListener("canplaythrough", n)
              };
            s.pause(), s.removeEventListener("timeupdate", a), s.removeEventListener("canplaythrough", n), s.src.includes(e.url) || (s.src = e.url), s.currentTime = 0, s.volume = .25, s.loop = !0, r({
              url: e.url,
              title: e.title,
              cover: e.cover,
              id: e.id
              ...
              duration: 0,
              ref: s
            })), s.readyState >= 3 ? n() : s.addEventListener("canplaythrough", n)
          },
          w = e => {
            b.current || (b.current = !0, e(), setTimeout(() => {
              b.current = !1
            }, 250))
          };
        return (0, s.jsxs)("div", {
          className: `${i().audioPlayer} ${e}`,
          ref: l,
          children: [n.cover && "" !== n.cover ? (0, s.jsx)("img", {
            src: n.cover,
            style: {
              ...
              children: [(0, s.jsx)(X.A, {
                ...
                children: "typewriter" === t.username_effects ? (0, s.jsxs)(s.Fragment, {
                  children: [(0, s.jsx)("style", {
                    children: `
                                        .username-typewriter .Typewriter {
                                            font-size: ${f.username.fontSize};
                                            font-weight: ${f.username.fontWeight};
                                        }
                                    `
                  }), (0, s.jsx)("div", {
                    className: "username-typewriter",
      ...
      function eV() {
        ...
        (0, a.useEffect)(() => {
          if (!(() => {
            ...
            n(!0), m.current = window.setTimeout(() => f(), 15e3)
          }, 2500), () => {
        ...
        return r || o ? (0, s.jsxs)(s.Fragment, {
          children: [(0, s.jsx)("div", {
      ...
      function e2({
        ...
        let [_, S] = (0, a.useState)(e.config ?? eq.hR), [w, N] = (0, a.useState)(_.premium), [C, $] = (0, a.useState)({
          ...
          cover: "",
          id: ""
        }), T = (0, a.useRef)(null), z = (0, a.useRef)(null), U = (0, a.useRef)(null), W = (0, a.useRef)(null), P = (0, a.useRef)(null), I = p({
          font: w.font,
          fontSize: w.font_size
        }), B = _.user_badges, D = e.discord?.user_badges ? B.includes("server_booster") || B.find(e => "server_booster" === e.name) ? [...e.discord.user_badges, "Server Booster"] : e.discord.user_badges : [], E = _.discord_presence_settings || {
          show_badges: !0,
          show_guild_tag: !0,
          idle_text: ""
        ...
        (0, a.useEffect)(() => {
          var t;
          let r, s;
          e.success && !e.ban && _.animated_title && (t = "" !== _.display_name ? _.display_name : e.username, r = 0, s = !0, setInterval(() => {
        ...
        return (0, a.useEffect)(() => {
          let s = r.get("templatePreview"),
            a = r.get("unlisted") || "false",
            n = r.get("templateId");
          s && !n || !s && n ? t.push(`/${g}`) : "true" === s && n ? (async () => {
            try {
              let t = await fetch(`https://guns.lol/api/users/templatePreview/${n}?unlisted=${a}`, {
                  method: "POST"
                }),
                r = await t.json(),
                s = r.error ? null : {
          ...
          children: [(0, s.jsx)("style", {
            ...
            children: [!e.premium && !n.templatePreview && (0, s.jsx)(eV, {}), (0, s.jsx)(o, {
              ...
              font: w.font,
              letterSpacing: w.font_letter_spacing
            }), (0, s.jsx)("div", {
      ...
      let n = ({
        ...
        return (0, a.useEffect)(() => {
          ...
          if (p) return (async () => {
            ...
            if (!f) return;
            let h = "inherit" === n ? window.getComputedStyle(p).fontFamily || "sans-serif" : n,
            ...
            let x = a.Children.toArray(e).join(""),
              v = document.createElement("canvas"),
              b = v.getContext("2d");
            if (!b) return;
            b.font = `${r} ${g} ${h}`, b.textBaseline = "alphabetic";
            let y = b.measureText(x),
              j = y.actualBoundingBoxLeft ?? 0,
              _ = y.actualBoundingBoxRight ?? y.width,
              S = y.actualBoundingBoxAscent ?? u,
              w = y.actualBoundingBoxDescent ?? .2 * u,
              N = Math.ceil(j + _),
              C = Math.ceil(S + w),
              $ = N + 10;
            v.width = $, v.height = C;
            ...
            let A = 5,
              ...
              U = () => {
                if (m) return;
                f.clearRect(-30, -30, $ + 60, C + 60);
                let e = z ? c : l;
                for (let t = 0; t < C; t++) {
                  let r = Math.floor(e * (Math.random() - .5) * 30);
                  f.drawImage(v, 0, t, $, 1, r, t, $, 1)
                }
            ...
            let W = (e, t) => e >= A && e <= k && t >= 0 && t <= T,
              P = e => {
                ...
                z = W(e.clientX - t.left, e.clientY - t.top)
              },
              I = () => {
                z = !1
              },
              B = e => {
                ...
                let t = p.getBoundingClientRect(),
                  r = e.touches[0];
                z = W(r.clientX - t.left, r.clientY - t.top)
              },
              D = () => {
                z = !1
              };
            o && (p.addEventListener("mousemove", P), p.addEventListener("mouseleave", I), p.addEventListener("touchmove", B, {
              passive: !1
            }), p.addEventListener("touchend", D)), p.cleanupFuzzyText = () => {
              window.cancelAnimationFrame(s), o && (p.removeEventListener("mousemove", P), p.removeEventListener("mouseleave", I), p.removeEventListener("touchmove", B), p.removeEventListener("touchend", D))
            }
          })(), () => {
            m = !0, window.cancelAnimationFrame(s), p && p.cleanupFuzzyText && p.cleanupFuzzyText()
          }
        }, [e, t, r, n, i, o, l, c]), (0, s.jsx)("canvas", {
          ref: u
        })
      };
      var i = r(45911),
        ...
        (0, a.useEffect)(() => {
          ...
          let t = A.current,
            ...
            z = () => {
              ...
              W.current = null, B.current = !1
            },
            E = () => {
              z(), W.current = new l.A(t, {
                type: "chars",
              ...
              let e = W.current.chars || [];
              P.current = [];
              let r = Math.max(1, Math.floor(x)),
                a = e => e.charAt(Math.floor(Math.random() * e.length)) || "";
              e.forEach(e => {
                ...
                for (let t = 0; t < r; t++) {
                  let t = e.cloneNode(!0);
                  _ && (t.textContent = a(_)), Object.assign(t.style, {
                    display: "inline-block",
                    width: n + "px",
                    textAlign: "center"
                  }), l.appendChild(t)
                ...
                i.os.set(l, {
                  x: u,
                  force3D: !0
                }), S && (l.style.color = S), l.setAttribute("data-final-x", String(m)), l.setAttribute("data-start-x", String(u)), P.current.push(o)
              })
            },
            L = () => {
              _ && P.current.forEach(e => {
                let t = e.firstElementChild;
                if (!t) return;
            ...
            F = () => {
              let e = P.current.map(e => e.firstElementChild);
              if (!e.length) return;
              B.current = !0;
              let t = i.os.timeline({
                  smoothChildTiming: !0,
                  ...
                  onComplete: () => {
                    B.current = !1, b || (P.current.forEach(e => {
                      let t = e.firstElementChild;
                      if (!t) return;
              ...
              if ("evenodd" === v) {
                let t = e.filter((e, t) => t % 2 == 1),
                  s = e.filter((e, t) => t % 2 == 0),
                  a = n + Math.max(0, t.length - 1) * j,
                  i = t.length ? .7 * a : 0;
                t.length && r(t, 0), s.length && r(s, i)
              } else e.forEach(e => {
                let r = Math.random() * d;
                t.to(e, {
      ...
      function n({
        ...
        return (0, s.useEffect)(() => {
          ...
          if ("object" == typeof e) {
            ...
            `, s.appendChild(r), () => {
              t.parentNode && s.removeChild(t), r.parentNode && s.removeChild(r)
            }
          }
        }, [e]), null
      }
